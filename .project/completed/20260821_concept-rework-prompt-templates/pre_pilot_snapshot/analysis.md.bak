...
For ARC's cost structure (>90% of known fabricated cost in capital, O&M not yet quantified), energy-revenue scales approximately inversely with capacity factor — but grid-value-weighted availability is less penalized than this naive estimate implies. Schwartz et al. (2024, arXiv:2405.01514) show that at 80% average annual availability with maintenance scheduled in low-electricity-price windows (spring to early summer), a fusion plant retains 91% of the value of a maintenance-free plant, not 80% as naive inverse scaling implies. At 65% availability, retained value is 80% (not 65%). The paper demonstrates that strategic maintenance scheduling — concentrating outages during low-price periods — recovers up to 15% of the naive penalty [arxiv-2405-01514.md §2.2 Results]. The concept achieves sub-$100/MWh LCOE only if capacity factor exceeds approximately 70–80% on a sustained, multi-year basis — a level not yet demonstrated for any fusion device. A 2× swing in capacity factor (50% → ~85%) remains the dominant LCOE lever at near-target REBCO prices, but the simple inverse relationship is an upper-bound penalty, not a central estimate. Maintenance scheduling strategy — block duration, frequency, and seasonal timing — is a second-order but non-negligible parameter: shorter, more frequent maintenance blocks frequently outperform longer, infrequent ones at the same average annual availability. The model should treat capacity factor as the primary output sensitivity and use the Schwartz et al. grid-value curve as the central estimate, not the naive inverse.
...
| **ARPA-E ALPHA Re-costing Reference** | | | | |
| LCOE (ALPHA compact fusion, NOAK, non-HTS) | 43 $/MWh (~$2.4/W; range 34–54 $/MWh) | osti-servlets-purl-1820946.md Table 4 (COE2) | low | Woodruff Scientific (2020); four compact MIF/Z-pinch concepts at ~500 MWe NOAK; 90% availability, 3-year construction, **zero contingency**. Applies to non-HTS compact fusion with no superconductor cost — lower bound reference, not ARC-specific. HTS magnet system cost would increase this materially. |
...
| 15 | FLiBe chemistry plant and tritium extraction system capital cost — ARC-specific BOP addition with no ARIES analogue | S5 | truly-unknown | important | ARC paper explicitly excludes BOP from cost scope; tritium extraction from FLiBe is identified only as an R&D requirement with no design or cost basis [arc-reactor-specifications.md §7]. Cannot be estimated from ARIES CAS fractions. **Order-of-magnitude anchor now available:** The Woodruff Scientific (2020) ARPA-E ALPHA re-costing study (osti-servlets-purl-1820946.md) provides a CAS-structured bottom-up cost for four compact MIF/Z-pinch concepts at ~500 MWe NOAK. Fuel Processing (CAS22.5) — defined as "tritium handling and production systems, including fuel injection and recovery systems" — averages $124M per plant (range $92–176M across the four concepts). These concepts differ from ARC in blanket chemistry (no FLiBe liquid immersion), confinement architecture (Z-pinch/MIF, not tokamak), and fuel cycle integration, so the analogy is structural — same CAS category and functional role — not direct. Treat **$100–200M as an order-of-magnitude floor** for ARC's FLiBe chemistry and tritium processing plant, not a point estimate. The FLiBe-specific chemistry (redox control, purification, MHD-driven flow) adds scope not present in the ALPHA concepts and may push ARC's actual cost above this range. |
...
12. **Schwartz et al. (2024), "The value of fusion energy to a decarbonized United States electric grid"** (PPPL/Princeton Andlinger Center, arXiv:2405.01514) — Grid-capacity-expansion study quantifying fusion plant value under realistic availability and maintenance scheduling. Key results: at 80% availability with maintenance scheduled in low-price windows, a plant retains 91% of the value of a maintenance-free plant (not 80% as naive inverse scaling implies); strategic scheduling recovers up to 15% of the naive availability penalty. Provides VO&M = $2.07/MWh_net ($1.74/MWh_gross) and parasitic power breakdown: 5% active (plasma heating, magnets, pumps) + 10% passive (cryogenics, vacuum, tritium handling). Found at: `/knowledge/concept_research/01-hts-compact-tokamak/iter-04/sources/arxiv-2405-01514.md`

13. **Woodruff Scientific (2020), ARPA-E ALPHA Program Re-costing Study** (OSTI:1820946) — CAS-structured bottom-up cost analysis for four compact MIF/Z-pinch fusion concepts at ~500 MWe NOAK (Plasma-Jet MIF, Stabilized Liner Compressor, Staged Z-Pinch, Flow-Stabilized Z-Pinch). Provides Fuel Processing (CAS22.5) at $124M average ($92–176M range), Power Supplies (CAS22.1.7) at $55.8M average, blanket/first wall (CAS22.1.1) at $57.3M average. Cross-concept NOAK LCOE: $43/MWh (range $34–54/MWh) at 90% availability, 3-year construction, zero contingency. Used as order-of-magnitude floor for ARC's FLiBe chemistry and tritium processing plant (Gap #15). Found at: `/knowledge/concept_research/01-hts-compact-tokamak/iter-04/sources/osti-servlets-purl-1820946.md`
