...
*Filled in when the orchestrator or owner engages. One entry per resolved issue — this is what the design agent reads to incorporate the review. The reviewer does not edit `design.md`.*
