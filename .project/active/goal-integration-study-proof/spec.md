...
2. **PR routing** `[OWNER 2026-08-28, reaffirmed 2026-08-29]`: Item 6 runs on `feat/wi033-p-pump-rebase`; its integrate run regenerates and commits the package through the seam; one PR ships WI-033 + Item 6 (pre_pr option (a), `.project/pre_pr/2026-08-28-pre-pr-wi033-p-pump-rebase.md`). The battery's 21 designed reds are expected to go green at that point and this is verified before the final gate.
