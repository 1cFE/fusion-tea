...
| 4 | C-BRIEF-1 | `4ac33d95` | Round agent launched on P0–P1; grounding wording owner-adopted verbatim |
...
| **Lean shape — briefs are the stage-instruction record** | The item's orchestrated run shape | `.project/active/goal-integration-study-proof/briefs/` holds nineteen stage briefs, each committed before its stage ran. They are how a later reader sees what each stage was told, in place of the review artifacts the lean shape omits. |
