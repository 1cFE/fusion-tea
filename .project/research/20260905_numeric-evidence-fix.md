...
Runtime prerequisite: [TEAx PR #5](https://github.com/rwestwood89/teax/pull/5). Its 432 tests pass. The companion codegen real-runtime lane passes 96 tests and demonstrates that the new acceptance fails against the old TEAx projection. Broader fusion-tea integration validation is in progress.
