...
def create_ife_tea_registry() -> PipelineModuleRegistry:
    ...
    return create_registry(
        [            Recirculating_Power_FractionModule,            Meier_COEModule,            Meier_HIF_Driver_CostModule,            Meier_Reactor_CostModule,            Meier_Total_Capital_CostModule,            IFE_LCOEModule,        ],
        module_type_override={            Recirculating_Power_FractionModule: "fusion_cycle.Recirculating_Power_FractionModule",            Meier_COEModule: "hif_economics.Meier_COEModule",            Meier_HIF_Driver_CostModule: "hif_economics.Meier_HIF_Driver_CostModule",            Meier_Reactor_CostModule: "hif_economics.Meier_Reactor_CostModule",            Meier_Total_Capital_CostModule: "hif_economics.Meier_Total_Capital_CostModule",            IFE_LCOEModule: "ife_lcoe.IFE_LCOEModule",        },
    )
