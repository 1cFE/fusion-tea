...
3. Open the corresponding `*_impl.py` file in `ife_tea/handwritten/`
...
6. Test: `python -c "from ife_tea.modules.<module> import <Module>"`
...
**Instructions**:
1. Create a test pipeline configuration in `ife_tea/pipelines/`
