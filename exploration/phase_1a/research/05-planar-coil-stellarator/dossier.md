...
- **Confidence**: high
- **Citation**: arXiv:2512.08027 — 12 encircling coils + 324 shaping coils, all planar and convex, wound in tension, max 20 T on coil, operating at 20 K; arXiv:2503.18960 (Canis prototype paper) explicitly confirms REBCO conductor
- **Notes**: This is the defining innovation. 12 large toroidal field coils (4 unique shapes) provide bulk confinement; 324 smaller individually controllable planar coils create the stellarator shaping. REBCO HTS, helium-cooled at 20 K. Complexity is transferred from hardware geometry to software control (450+ independent control variables). Thea has demonstrated a 3x3 superconducting planar coil array prototype (Canis) with 10x better optimization than W7-X. Eos design has achieved ~50% coil reduction from original design, now requiring only one size shaping coil.
...
- **Helios**: Full preconceptual design published (arXiv:2512.08027, ~200-page report, DOE Milestone-certified January 13, 2026 — first company certified under the DOE Milestone-Based Fusion Development Program). 1.1 GW thermal, 390 MWe net.
- **Eos**: Design published in Nuclear Fusion (Jan 2025). Demonstration stellarator / neutron source. Optimized design achieves ~50% coil reduction from original, requiring only one size shaping coil.
...
- **Canis** (Thea Energy): Company's own superconducting 3x3 planar coil array prototype (2025), demonstrated stellarator-relevant field production with 10x better optimization than W7-X. REBCO conductor confirmed (arXiv:2503.18960).
...
Iteration 2 resolved the one minor uncertainty: the HTS conductor is now explicitly confirmed as REBCO via the Canis prototype paper (arXiv:2503.18960).
...
2. **arXiv:2503.18960** — Canis prototype paper. Confirms REBCO conductor, demonstrates 3x3 superconducting planar coil array.
   - https://arxiv.org/html/2503.18960v1

3. **Thea Energy website** — Technology page, Eos page, press releases
...
4. **Nuclear Fusion papers** (Jan 2025) — 4 peer-reviewed papers on planar coil stellarator approach (referenced via press release; not individually fetched)

5. **ANS Nuclear Newswire** — https://www.ans.org/news/2025-12-18/article-7628/

6. **Interesting Engineering** — https://interestingengineering.com/energy/thea-energy-unveils-helios-realistic-fusion-power-plant

7. **POWER Magazine** — https://www.powermag.com/thea-energy-completes-fusion-power-plant-preconceptual-design/

8. **PPPL** — Edison Patent Award and DOE Milestone selection press releases
