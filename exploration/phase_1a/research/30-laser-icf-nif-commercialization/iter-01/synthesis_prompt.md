# Dossier Synthesis: Laser ICF - NIF Commercialization (D-T)
...
1. **Current dossier**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/30-laser-icf-nif-commercialization/dossier.md`
   (Does not exist yet — you will create it from scratch.)
   

2. **New research**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/30-laser-icf-nif-commercialization/iter-01/output.md`
...
Write the complete dossier to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/30-laser-icf-nif-commercialization/dossier.md` using the structure below. This OVERWRITES the previous dossier — include all information, not just changes.
...
Append the following to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/30-laser-icf-nif-commercialization/changelog.md`:
...
- **Concept Name**: Laser ICF - NIF Commercialization (D-T)
- **Company**: Inertia Enterprises
- **Confinement Approach**: Inertial Confinement
- **Description**: Commercializing proven NIF indirect-drive laser ICF physics. Founded by former Twilio CEO Jeff Lawson with NIF scientists Annie Kritcher and Mike Dunne. Building Thunderwall laser and mass-manufacturing fuel targets. $450M Series A (Feb 2026).
- **Fuel Type**: D-T (Deuterium-Tritium)
- **Operation Mode**: Pulsed
- **Published Machine/Plant?**: No
- **Lab Experiments**: NIF (LLNL)
