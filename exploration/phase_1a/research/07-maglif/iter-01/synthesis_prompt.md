...
1. **Current dossier**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/07-maglif/dossier.md`
   (Does not exist yet — you will create it from scratch.)
   

2. **New research**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/07-maglif/iter-01/output.md`
...
Write the complete dossier to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/07-maglif/dossier.md` using the structure below. This OVERWRITES the previous dossier — include all information, not just changes.
...
Append the following to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/07-maglif/changelog.md`:
...
- **Lab Experiments**: Sandia Z Machine (MagLIF experiments), NRL (magnetized ICF)
