# Dossier Synthesis: Electrostatic Hybrid (D-T)
...
1. **Current dossier**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/13-electrostatic-hybrid/dossier.md`
   (Does not exist yet — you will create it from scratch.)
   

2. **New research**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/13-electrostatic-hybrid/iter-01/output.md`
...
Write the complete dossier to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/13-electrostatic-hybrid/dossier.md` using the structure below. This OVERWRITES the previous dossier — include all information, not just changes.
...
Append the following to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/13-electrostatic-hybrid/changelog.md`:
...
- **Concept Name**: Electrostatic Hybrid (D-T)
- **Company**: Avalanche Energy
- **Confinement Approach**: Hybrid
- **Description**: Ions orbit high-voltage cathode without grid. ExB electron confinement. Desktop-scale form factor. Hybrid electrostatic/magnetic confinement concept.
- **Fuel Type**: D-T (Deuterium-Tritium)
- **Operation Mode**: Pulsed
- **Published Machine/Plant?**: No
- **Lab Experiments**: IEC/Fusor experiments (various universities)
