...
Example:
    ...
    """
    return (((((inputs.fixed_base + (inputs.fus_base * ((inputs.p_fus * inputs.n_mod) / inputs.p_fus_ref))) + (inputs.staff_base * (((inputs.p_et * inputs.n_mod) / inputs.p_et_ref) ** 0.5))) + (inputs.the_base * ((inputs.p_the * inputs.n_mod) / inputs.p_the_ref))) + (inputs.th_base * ((inputs.p_th * inputs.n_mod) / inputs.p_th_ref))) + (inputs.et_base * ((inputs.p_et * inputs.n_mod) / inputs.p_et_ref)))
