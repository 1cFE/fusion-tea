...
Example:
    ...
    """
    return (((((((inputs.shipping_frac * inputs.cas20) + (inputs.spares_frac * inputs.cas23_to_28)) + (inputs.tax_frac * inputs.cas20)) + (inputs.insurance_frac * (inputs.cas20 + inputs.cas30))) + (inputs.startup_fuel_base * ((inputs.n_mod_in * inputs.p_net) / inputs.ref_net_power))) + (inputs.decom_base * ((inputs.n_mod_in * inputs.p_net) / inputs.ref_net_power))) * (1.0 + inputs.contingency_rate_in))
