...
Example:
    ...
    """
    return ((inputs.primary_base * ((inputs.n_mod_in * inputs.p_net) / inputs.ref_net_power)) + (inputs.intermediate_base * (((inputs.n_mod_in * inputs.p_th_in) / inputs.p_th_ref) ** inputs.alpha)))
