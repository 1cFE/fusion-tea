...
SysML Source: root-0/analyses/mfe_plasma_sustainment.sysml:4
    ...
    p_avg: float = Field(description="p_avg output")
    ...
    alpha_n_e_eff: float = Field(description="alpha_n_e_eff output")
    ...
    n_e_volav: float = Field(description="n_e_volav output")
    alpha_He_eff: float = Field(description="alpha_He_eff output")
