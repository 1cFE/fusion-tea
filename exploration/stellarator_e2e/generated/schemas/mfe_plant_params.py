...
class MfePlantParams(BaseModel):
    ...
    stellarator_09__stellaris__aux_cooling__n_mod: float = Field(default=1.0, description="Entry point: n_mod")
    ...
    stellarator_09__stellaris__buildings_cost__n_mod: float = Field(default=1.0, description="Entry point: n_mod")
    ...
    stellarator_09__stellaris__coolant__n_mod: float = Field(default=1.0, description="Entry point: n_mod")
    ...
    stellarator_09__stellaris__fuel_calc__n_mod: float = Field(default=1.0, description="Entry point: n_mod")
    stellarator_09__stellaris__fuel_handling__alpha: float = Field(default=0.7, description="Entry point: alpha")
    stellarator_09__stellaris__fuel_handling__n_mod: float = Field(default=1.0, description="Entry point: n_mod")
    ...
    stellarator_09__stellaris__inc_cost__n_mod: float = Field(default=1.0, description="Entry point: n_mod")
    ...
    stellarator_09__stellaris__lcoe_1cfe_calc__n_mod: float = Field(default=1.0, description="Entry point: n_mod")
    ...
    stellarator_09__stellaris__om_cost__n_mod: float = Field(default=1.0, description="Entry point: n_mod")
    ...
    stellarator_09__stellaris__other_rpe__n_mod: float = Field(default=1.0, description="Entry point: n_mod")
    ...
    stellarator_09__stellaris__owner__n_mod: float = Field(default=1.0, description="Entry point: n_mod")
    ...
    stellarator_09__stellaris__precon_cost__n_mod: float = Field(default=1.0, description="Entry point: n_mod")
    ...
    stellarator_09__stellaris__supplementary__contingency_rate: float = Field(default=0.0, description="Entry point: contingency_rate")
    ...
    stellarator_09__stellaris__supplementary__n_mod: float = Field(default=1.0, description="Entry point: n_mod")
    ...
    stellarator_09__stellaris__waste__n_mod: float = Field(default=1.0, description="Entry point: n_mod")
