...
class MfePlantParams(BaseModel):
    ...
    """
    stellarator_09__stellaris__blanket__blanket_vol: float = Field(default=1118.695, description="Entry point: blanket_vol")
    ...
    stellarator_09__stellaris__magnet__r_coil: float = Field(default=3.2, description="Entry point: r_coil")
    ...
    stellarator_09__stellaris__shield__shield_vol: float = Field(default=552.14, description="Entry point: shield_vol")
    ...
    stellarator_09__stellaris__structure__structure_vol: float = Field(default=219.979, description="Entry point: structure_vol")
    ...
    stellarator_09__stellaris__vessel__vessel_vol: float = Field(default=157.933, description="Entry point: vessel_vol")
