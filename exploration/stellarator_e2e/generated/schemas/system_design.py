...
class SystemDesign(BaseModel):
    ...
    stellarator_09__stellaris__geom__f_shape: float = Field(default=0.794259, description="Entry point: f_shape")
    ...
    stellarator_09__stellaris__rb__a: float = Field(default=1.5, description="Entry point: a")
