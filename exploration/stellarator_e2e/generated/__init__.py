...
from stellarator_tea.modules.stellarator_09.stellaris.direct_capital import direct_capitalModule
...
def create_stellarator_tea_registry() -> PipelineModuleRegistry:
    ...
    return create_registry(
        [            ConstraintReportAggregatorModule,            Annual_OM_CostModule,            Blanket_CostModule,            Buildings_CostModule,            Contingency_CostModule,            Divertor_CostModule,            Heating_CostModule,            Indirect_CostModule,            Linear_Power_CostModule,            Power_Supplies_CostModule,            Preconstruction_CostModule,            Shield_CostModule,            Structure_CostModule,            Vessel_CostModule,            Cryoplant_Electrical_PowerModule,            LCOE_DCFModule,            Magnet_Coil_CostModule,            DT_Fusion_PowerModule,            MFE_Radial_BuildModule,            Neutron_Wall_LoadModule,            Plasma_GeometryModule,            MFE_Power_Balance_CalcModule,            StellarisBetaOkConstraintModule,            StellarisNetPositiveConstraintModule,            StellarisRecircOkConstraintModule,            StellarisTbrOkConstraintModule,            StellarisWallLoadOkConstraintModule,            bop_capitalModule,            direct_capitalModule,            powercore_capitalModule,            total_capitalModule,        ],
        module_type_override={            ConstraintReportAggregatorModule: "constraints.ConstraintReportAggregatorModule",            Annual_OM_CostModule: "mfe_account_costs.Annual_OM_CostModule",            Blanket_CostModule: "mfe_account_costs.Blanket_CostModule",            Buildings_CostModule: "mfe_account_costs.Buildings_CostModule",            Contingency_CostModule: "mfe_account_costs.Contingency_CostModule",            Divertor_CostModule: "mfe_account_costs.Divertor_CostModule",            Heating_CostModule: "mfe_account_costs.Heating_CostModule",            Indirect_CostModule: "mfe_account_costs.Indirect_CostModule",            Linear_Power_CostModule: "mfe_account_costs.Linear_Power_CostModule",            Power_Supplies_CostModule: "mfe_account_costs.Power_Supplies_CostModule",            Preconstruction_CostModule: "mfe_account_costs.Preconstruction_CostModule",            Shield_CostModule: "mfe_account_costs.Shield_CostModule",            Structure_CostModule: "mfe_account_costs.Structure_CostModule",            Vessel_CostModule: "mfe_account_costs.Vessel_CostModule",            Cryoplant_Electrical_PowerModule: "mfe_cryo_plant.Cryoplant_Electrical_PowerModule",            LCOE_DCFModule: "mfe_lcoe_dcf.LCOE_DCFModule",            Magnet_Coil_CostModule: "mfe_magnet_cost.Magnet_Coil_CostModule",            DT_Fusion_PowerModule: "mfe_plasma_scaling.DT_Fusion_PowerModule",            MFE_Radial_BuildModule: "mfe_plasma_scaling.MFE_Radial_BuildModule",            Neutron_Wall_LoadModule: "mfe_plasma_scaling.Neutron_Wall_LoadModule",            Plasma_GeometryModule: "mfe_plasma_scaling.Plasma_GeometryModule",            MFE_Power_Balance_CalcModule: "mfe_power_balance.MFE_Power_Balance_CalcModule",            StellarisBetaOkConstraintModule: "stellarator_09.StellarisBetaOkConstraintModule",            StellarisNetPositiveConstraintModule: "stellarator_09.StellarisNetPositiveConstraintModule",            StellarisRecircOkConstraintModule: "stellarator_09.StellarisRecircOkConstraintModule",            StellarisTbrOkConstraintModule: "stellarator_09.StellarisTbrOkConstraintModule",            StellarisWallLoadOkConstraintModule: "stellarator_09.StellarisWallLoadOkConstraintModule",            bop_capitalModule: "stellarator_09.stellaris.bop_capitalModule",            direct_capitalModule: "stellarator_09.stellaris.direct_capitalModule",            powercore_capitalModule: "stellarator_09.stellaris.powercore_capitalModule",            total_capitalModule: "stellarator_09.stellaris.total_capitalModule",        },
    )
