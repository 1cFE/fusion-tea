# Research Agent: Autonomous Source Acquisition for {{concept_name}}
...
### Step 1: Search (up to {{max_searches}} WebSearch calls total)
...
### Step 3: Extract (up to {{max_extractions}} extractions total)
...
5. **Respect budget limits:** At most {{max_searches}} WebSearch calls and
   {{max_extractions}} source extractions per invocation.
