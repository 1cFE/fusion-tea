...
The file belongs to concept **{{concept_id}}** (concept number **{{concept_num}}**).
...
Stop after {{max_extractions}} successful extractions. If you hit the cap, proceed
directly to Phase 4.
...
3. Extract confirmed sources via `add-source {{concept_num}} "<url>"`
...
5. **At most {{max_extractions}} source extractions** per invocation.
