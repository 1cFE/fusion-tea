# Source Acquisition: Re-source zap-energy-website-how-it-works.orig.md
...
The file belongs to concept **15-sheared-flow-stabilized-z-pinch** (concept number **15**).
...
3. Extract confirmed sources via `add-source 15 "<url>"`
...
`/tmp/resurface/15-zap-energy-website-how-it-works.json`

Use this exact format:

```json
{
  "orig_file": "zap-energy-website-how-it-works.orig.md",
