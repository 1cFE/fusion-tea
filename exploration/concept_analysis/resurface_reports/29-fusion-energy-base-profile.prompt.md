# Source Acquisition: Re-source fusion-energy-base-profile.orig.md
...
The file belongs to concept **29-negative-triangularity-tokamak** (concept number **29**).

## The Legacy File

```
# Firefly Fusion – Fusion Energy Base Profile

**Source**: https://www.fusionenergybase.com/organizations/firefly-fusion
**Accessed**: 2026-03-06

## Key Details

- **Confinement type**: Compact, high-field tokamaks
- **Magnet strategy (phased)**: "copper magnet coils during development and eventually high temperature superconducting (HTS) coils for future commercial power plants"
- **Location**: Aix-en-Provence, France
- **Founded**: 2024

## Notes
- Confirms the two-phase magnet strategy: copper (prototype LUCIOLE) → HTS (commercial)
- No details on heating method, fuel, energy capture, or blanket
...
3. Extract confirmed sources via `add-source 29 "<url>"`
...
`/tmp/resurface/29-fusion-energy-base-profile.json`

Use this exact format:

```json
{
  "orig_file": "fusion-energy-base-profile.orig.md",
