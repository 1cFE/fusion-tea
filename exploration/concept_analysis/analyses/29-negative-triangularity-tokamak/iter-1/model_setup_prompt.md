# 1costingfe Model Setup: Negative-Triangularity Tokamak

You are generating a runnable 1costingfe model setup script for **Negative-Triangularity Tokamak**
(Firefly Fusion). The script must run via `uv run python model_setup.py` and emit an
LCOE estimate.
...
**Start here.** Open `C:\Users\mallo\Deterministic_Concept_scoring\fusion-tea\exploration\concept_analysis\analyses\29-negative-triangularity-tokamak\analysis.md` and read its `## Design Point` block and
...
## Output
Write the script to: `C:\Users\mallo\Deterministic_Concept_scoring\fusion-tea\exploration\concept_analysis\analyses\29-negative-triangularity-tokamak\iter-1\model_setup.py`
