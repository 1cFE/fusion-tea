...
- **Missing at scale**: Burning-plasma NT experiment at reactor-relevant Q. Demonstration that NT confinement advantage persists with high alpha-particle pressure. Validation of density peaking predictions (MANTA's TGLF model "has shown significant variability" [manta-reference-design.md §2.2.2]). NT disruption characterization at high plasma current and energy. Vertical stability characterization and passive/active stabilizer design validation in NT geometry at reactor-relevant elongation and poloidal beta — NT equilibria are intrinsically less vertically stable than PT and growth rates depend on the specific plate geometry, which has not been validated at reactor scale [arxiv-2401-15217.md §Abstract].
...
| 15 | NT vertical stability engineering design — passive stabilizer plate geometry, cost, growth rate validation at reactor-relevant elongation and poloidal beta | S2, S3 | not-yet-sourced | important | Markovičiūtė et al. (2024) demonstrate feasibility with optimized passive outboard plates; cost of stabilizer infrastructure not captured in MANTA cost accounting [arxiv-2401-15217.md] |
...
- **Divertor challenge**: Tokamak Energy's ST-E1 shares the conventional positive-triangularity divertor challenge — managing high P_SOL per unit divertor area with MAST-U Super-X geometry. NT tokamak's P_SOL = 23.5 MW for 450 MW fusion is dramatically lower than any comparable PT design, fundamentally changing the divertor engineering problem. NT eliminates the need for advanced divertor concepts (Super-X, snowflake, liquid metal) — a meaningful capital and risk reduction not present in the ST-E1 analysis. The concrete quantification of this advantage: MANTA NT achieves 2.8 MW/m² peak divertor heat flux vs. ARIES-ACT ACT1's 13.7 MW/m² (advanced PT, δ=0.63) and ACT2's 10 MW/m² (conservative PT) [osti-servlets-purl-1178069.md §Executive Summary, §Table III] — a ~5× reduction in peak heat flux that enables the simpler conventional tungsten divertor MANTA employs.
...
**10. Markovičiūtė, I. et al. (2024) — NT Vertical Stability Analysis**
...
**11. Approved D1+ Analysis: Spherical Tokamak - HTS (21-spherical-tokamak-hts)**
