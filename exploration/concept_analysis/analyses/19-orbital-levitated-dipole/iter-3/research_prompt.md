# Research Agent: Autonomous Source Acquisition for Orbital Levitated Dipole (D-He3)
...
### G-13: Power beaming efficiency chain (conversion → transmitter → atmosphere → rectenna) — SPS literature (JAXA, DoE) provides MW-scale beaming efficiency data; atmospheric models available [PARTIAL]
- Iteration 2: searched "space solar power wireless power transmission efficiency microwave beaming rectenna MW-scale site:osti.gov OR site:arxiv.org", "space solar power SPS efficiency chain DC-RF conversion rectenna atmospheric attenuation end-to-end percent site:arxiv.org OR site:osti.gov"
  - Extracted: arxiv-2401-15267 (https://arxiv.org/abs/2401.15267)

### G-15: He3 global production capacity and price trajectory — DOE Office of Science He3 strategic supply reports; NAS He3 supply study (2010) provides baseline [CLOSED]
- Iteration 2: searched "helium-3 global production capacity supply DOE strategic reserve price site:osti.gov OR site:nap.edu", "helium-3 production supply shortage fusion fuel kg per year price DOE NNSA 2020 2024"
  - Extracted: everycrsreport-reports-r41419 (https://www.everycrsreport.com/reports/R41419.html)
...
```
uv run python scripts/run_analysis.py add-source 19 "<url>"
```
...
`/home/reid/1cfe/fusion-tea/exploration/concept_analysis/analyses/19-orbital-levitated-dipole/iter-3/research_output.json`
