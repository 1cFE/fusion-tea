...
Historical end-to-end DC-DC demonstrations: 26.5% (1970 Marshall Space Flight Center), 54% (1975 Raytheon Lab, 495 W with magnetron). With realistic phased-array steering, the realistic end-to-end efficiency is roughly 14% or less (product of <20% × 89% × 80%). Laser power beaming is far less efficient at large scale. The complete absence of a conversion specification makes the delivered power — and thus any LCOE calculation — formally undefined.
...
| Power beaming — end-to-end DC-DC (realistic, with phased-array) | ~14% or less | nss-wp-content-uploads-2017-07-space-solar-power-workshop.md §6 | low | Product of <20% (TX) × 89% (beam) × 80% (rectenna); historical demonstrations: 26.5% (1970 MSFC), 54% (1975 Raytheon Lab, 495 W magnetron) |
...
**13. CRS Report R41419 — "The Helium-3 Shortage: Supply, Demand, and Options for Congress" (2011)**
