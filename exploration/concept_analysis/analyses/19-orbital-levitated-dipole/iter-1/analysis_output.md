...
| D-He3 He3 market price | ~$5,000–6,000/std L (~$28–34M/kg) | [estimated from well-known DOE/NNSA market pricing; no Zephyr source] | medium | Well-known market constraint; not addressed in any Zephyr source |
| Global He3 production | ~10,000–15,000 std L/year (~1.8–2.7 kg/year) | [estimated from DOE strategic He3 supply reports; not in Zephyr sources] | medium | Primary source: tritium decay at US and Russian weapons programs |
...
| 14 | Regulatory framework for nuclear operations in LEO | S2 | truly-unknown | important | IAEA Outer Space Nuclear Safety Guidelines (2023); UN COPUOS nuclear power sources principles |
