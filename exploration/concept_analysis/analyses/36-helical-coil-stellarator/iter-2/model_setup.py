...
# - Geometry: R0 = 7.8 m, a = 1.87 m per Table I lines 129-130. NOTE: analysis.md Section 5
#   incorrectly states R0 = 8.0 m, a = 2.0 m (lines 220-221); model uses authoritative source values.
