...
The HESTIA design targets >50% thermal-to-electric conversion efficiency via an sCO₂ Brayton cycle at 800–1200 K working temperature. This efficiency is central to achieving Q_eng = 2.0 at Q (plasma) = 13 — a modest plasma gain. If conventional steam Rankine (~33–38% efficiency) is substituted, Q_eng drops below 2.0, and net output decreases significantly from the 70 MWe target. The NIFS Oroshhi-2 platform has a proposed sCO₂ demonstration targeting >50% efficiency, but a 20 kWe laboratory demonstration at 20% efficiency is the current state [helical-fusion-2025-2026-updates.md]. No fusion-coupled sCO₂ demonstration exists.
