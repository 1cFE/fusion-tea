# 1costingfe Model Setup: Helical-Coil Stellarator (HESTIA)

You are generating a runnable 1costingfe model setup script for **Helical-Coil Stellarator (HESTIA)**
(Helical Fusion). The script must run via `uv run python model_setup.py` and emit an
LCOE estimate.
...
**Start here.** Open `C:\Users\mallo\Deterministic_Concept_scoring\fusion-tea\exploration\concept_analysis\analyses\36-helical-coil-stellarator\analysis.md` and read its `## Design Point` block and
...
## Output
Write the script to: `C:\Users\mallo\Deterministic_Concept_scoring\fusion-tea\exploration\concept_analysis\analyses\36-helical-coil-stellarator\iter-1\model_setup.py`
