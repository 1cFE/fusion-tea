# 1costingfe Model Setup: Laser ICF - French National Direct Drive (D-T)

You are generating a runnable 1costingfe model setup script for **Laser ICF - French National Direct Drive (D-T)**
(GenF Systems).
...
## Output
Write the script to: `/home/reid/1cfe/fusion-tea/exploration/concept_analysis/analyses/32-laser-icf-french-national/iter-1/model_setup.py`
