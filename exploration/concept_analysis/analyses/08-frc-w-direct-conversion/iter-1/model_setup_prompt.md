...
**Start here.** Open `/home/reid/1cfe/fusion-tea-cohort-rerun/exploration/concept_analysis/analyses/08-frc-w-direct-conversion/analysis.md` and read its `## Design Point` block and
...
## Output
Write the script to: `/home/reid/1cfe/fusion-tea-cohort-rerun/exploration/concept_analysis/analyses/08-frc-w-direct-conversion/iter-1/model_setup.py`
