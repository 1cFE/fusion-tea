# Research Agent: Autonomous Source Acquisition for HTS Compact Tokamak
...
### G-1: Full plant capital cost including BoP, indirect costs, construction financing [CLOSED]
- Iteration 4: searched "ARIES-AT fusion power plant full capital cost study Najmabadi 2006 site:osti.gov", "ARIES-AT fusion power plant LCOE cost breakdown balance of plant"
  - Extracted: osti-etdeweb-servlets-purl-20261446 (https://www.osti.gov/etdeweb/servlets/purl/20261446)
- Iteration 6: searched "Woodruff pyFECONS fusion power plant balance of plant cost 2025 2026 site:osti.gov OR site:arxiv.org"
  - Extracted: arxiv-2601-21724 (https://arxiv.org/pdf/2601.21724)
  - Extracted: arxiv-2602-19389 (https://arxiv.org/pdf/2602.19389)

### G-12: Li-6 enrichment supply chain and cost at fleet scale [PARTIAL]
- Iteration 4: searched "Li-6 lithium-6 enrichment cost supply chain fusion tritium DOE ORNL site:osti.gov"
- Iteration 6: searched "Li-6 lithium-6 enrichment cost supply chain fusion tritium breeding DOE ORNL site:osti.gov", "lithium-6 enrichment cost production fusion fleet scale supply chain 2020 2025 arxiv OR osti"
  - Extracted: sciencedirect-science-article-pii-s092037961930835x (https://www.sciencedirect.com/science/article/pii/S092037961930835X)

### G-8: REBCO tape learning rate ($/kA-m trajectory to commercial target) [PARTIAL]
- Iteration 4: searched (no queries)
- Iteration 5: searched "REBCO HTS tape cost learning rate $/kA-m commercial roadmap superconductor"
  - Extracted: sciencedirect-science-article-pii-s2772830725000390 (https://www.sciencedirect.com/science/article/pii/S2772830725000390)

### G-10: Blanket replacement schedule / FLiBe system service life [PARTIAL]
- Iteration 4: searched (no queries)
- Iteration 5: searched "FLiBe blanket replacement lifetime tritium breeding service life fusion reactor ITER TBM"
  - Extracted: osti-servlets-purl-1305833 (https://www.osti.gov/servlets/purl/1305833)

### G-11: LHCD system (8 GHz, 25 MW) cost and technology readiness [PARTIAL]
- Iteration 4: searched (no queries)
- Iteration 5: searched "lower hybrid current drive LHCD system cost tokamak ITER 5GHz benchmark", "ITER lower hybrid current drive system cost estimate million dollars klystron antenna 2026"
  - Extracted: osti-etdeweb-servlets-purl-10149275 (https://www.osti.gov/etdeweb/servlets/purl/10149275)

### G-13: Regulatory cost impact specific to NRC Part 30 framework [FAILED]
- Iteration 4: searched (no queries)
- Iteration 6: searched "NRC fusion regulatory cost impact tokamak Part 50 Stewart Shirvan 2022 licensing fee site:osti.gov OR site:arxiv.org", "NRC fusion Part 30 byproduct material regulatory framework cost analysis economic impact 2023 2024 2025 site:nrc.gov OR site:federalregister.gov"
  - Failed: https://www.federalregister.gov/documents/2026/02/26/2026-03865/regulatory-framework-for-fusion-machines — Redirect to unblock.federalregister.gov — geo-blocking or bot protection.
  - Failed: https://www.nrc.gov/docs/ML2102/ML21026A315.pdf — WebFetch timeout.

### G-14: Divertor replacement cost and frequency for compact tokamak geometry [SKIPPED]
- Iteration 4: searched (no queries)
- Iteration 6: searched "divertor replacement cost frequency compact tokamak ITER EU-DEMO component maintenance schedule site:osti.gov OR site:arxiv.org"
...
```
uv run python scripts/run_analysis.py add-source 01 "<url>"
```
...
`/home/reid/1cfe/fusion-tea/exploration/concept_analysis/analyses/01-hts-compact-tokamak/iter-7/research_output.json`
