...
### Step 1: Search (up to 2 WebSearch calls total)
...
### Step 3: Extract (up to 1 extractions total)
...
5. **Respect budget limits:** At most 2 WebSearch calls and
   1 source extractions per invocation.
...
`/home/reid/1cfe/fusion-tea/exploration/concept_analysis/analyses/01-hts-compact-tokamak/iter-4/research_output.json`
