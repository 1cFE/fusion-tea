...
You are performing a data gap assessment for the fusion concept **HTS Compact Tokamak (D-T)** (Commonwealth Fusion Systems) as preparation for a comprehensive qualitative and quantitative concept analysis.
...
- **Dossier**: `/home/reid/1cfe/fusion-tea/knowledge/concept_research/01-hts-compact-tokamak/dossier.md`
...
1. **Skim the index below first** to identify which fleet-wide sources are plausibly applicable to **HTS Compact Tokamak (D-T)** (match on confinement family, fuel cycle, plant type, or cost-modeling scope).
