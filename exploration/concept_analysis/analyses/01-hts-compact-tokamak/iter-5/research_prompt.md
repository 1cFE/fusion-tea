...
### G-8: REBCO tape learning rate ($/kA-m trajectory to commercial target) [SKIPPED]
- Iteration 4: searched (no queries)

### G-10: Blanket replacement schedule / FLiBe system service life [SKIPPED]
- Iteration 4: searched (no queries)

### G-11: LHCD system (8 GHz, 25 MW) cost and technology readiness [SKIPPED]
- Iteration 4: searched (no queries)
...
`/home/reid/1cfe/fusion-tea/exploration/concept_analysis/analyses/01-hts-compact-tokamak/iter-5/research_output.json`
