# Research Agent: Autonomous Source Acquisition for Laser ICF - Hybrid Direct Drive (D-T)
...
```
uv run python scripts/run_analysis.py add-source 17a "<url>"
```
...
`/home/reid/1cfe/fusion-tea/exploration/concept_analysis/analyses/17a-laser-icf-hybrid-drive/iter-5/research_output.json`
