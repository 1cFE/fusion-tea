...
| p_input_MW | ~80 MW | [inferred: 8 MJ/shot × ~0.07 wall-plug eff⁻¹ × ~0.7 Hz ≈ 80 MW wallplug draw; whitepaper §Next Steps states recirc fraction <15% of gross] | low | spec key: `p_input`. Recirculating power for the laser driver. Highly dependent on achieved rep rate and wall-plug efficiency. |
...
| recirculating_power_fraction | <15% (11–13% at NOAK) | xec-whitepaper §Roadmap, §Next Steps | medium | At 7% efficiency and 250 gain; Athena at ~5% eff may be higher |
...
- **C220104** (Primary pulsed driver — laser): The whitepaper provides FOAK laser cost of $100–$120/J on-target and NOAK of $60–$80/J on-target. At 8 MJ on-target for Athena, this gives a FOAK laser system cost of $800M–$960M and NOAK of $480M–$640M. This is company-published and the most grounded cost data point in the dossier. The library default for a laser IFE driver is unlikely to reflect the specific KrF excimer + NLO architecture's cost claims. **Override justified.**
...
overrides:
  - account: C220104
    ...
    rationale: |
      Xcimer published FOAK laser cost of $100-$120/J on-target (Table 1 with component
      breakdown: capacitors $10/J, Marx generators $24/J, e-beam $17/J, laser chamber $19/J,
      optics $12/J, NLO/seed $23/J, controls $4/J). At 8 MJ on-target for Athena:
      $120/J × 8 MJ = $960M (using upper bound for FOAK conservatism). Library default
      for a generic laser IFE driver does not reflect the KrF excimer + NLO architecture.
      NOAK would be $60-$80/J × 8 MJ = $480-$640M.
