...
#    - q_eng = 8.2: whitepaper §Roadmap, Q_eng at 7% laser WPE and 250 target gain
#      (recirculating power fraction <11-13%). This is the NOAK target; Athena at
#      ~5% WPE would be lower (~5-6), but NOAK value is appropriate for the NOAK
#      framework.
...
spec = dict(
    q_eng=8.2,    # Engineering Q (NOAK target); xec-whitepaper §Roadmap
...
#    8 enabled overrides for Low archetype-fit (expected band: 6-12).
...
overrides = [
    ...
    # CAS70: O&M — no first-wall replacement due to thick-liquid wall.
    {
        "account": "CAS70",
        ...
        "source": "xec-20260224-commercialization-of-lfe-whtppr-shared-24-feb.md §Chamber Design",
        "rationale": (
            "Xcimer claims no first-wall or blanket replacement over 30-year facility lifetime "
            "due to thick-liquid-wall protection. This eliminates the dominant scheduled "
            "component replacement cost that drives CAS70 in solid-wall concepts. However, "
            "FLiBe loop maintenance (pumps, heat exchangers, redox control) and laser system "
            "maintenance (gas replacement, capacitor aging) are real O&M costs. 0.75x multiplier "
            "reflects elimination of first-wall replacements offset by FLiBe-specific "
            "maintenance. No company O&M figure; analyst estimate."
        ),
        "cost_basis": "noak",
    },
]
