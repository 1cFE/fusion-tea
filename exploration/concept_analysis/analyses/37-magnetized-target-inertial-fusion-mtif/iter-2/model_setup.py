...
#    Analysis Section 5b: "Zero enabled overrides. Expected band for Med archetype-fit
#    is 3–8. The discrepancy reflects the extreme opacity of NearStar's public
#    materials. Almost no quantitative cost, performance, or engineering data has
#    been disclosed."
overrides = [
    # All overrides disabled due to insufficient company-grounded data.
    # Included here for traceability to analysis Section 5b findings.

    {
        "account": "C220107",
        "value": 20.0,  # M$
        "enabled": False,
        "blocked_by": "1cFE/fusion-tea#1",
        "provenance": "derived",
        ...
        "rationale": (
            ...
            "(at 10–30% efficiency). At $4/J mid-range for industrial capacitors, a 5 MJ bank costs $20M. "
            "This is derived from railgun efficiency analogies and capacitor industry pricing, not from "
            "NearStar-published data. NearStar claims COTS construction but provides no cost breakdown. "
            "Disabled because actual cost could be factor of 2–3× different depending on capacitor technology "
