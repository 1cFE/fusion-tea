# Research Agent: Autonomous Source Acquisition for Magnetized Target Inertial Fusion - MTIF (D-D)
...
```
uv run python scripts/run_analysis.py add-source 37 "<url>"
```
...
`/home/reid/1cfe/fusion-tea/exploration/concept_analysis/analyses/37-magnetized-target-inertial-fusion-mtif/iter-2/research_output.json`
