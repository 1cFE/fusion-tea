...
- availability = 0.80 — UNCERTAIN, pulsed (15+ min on / dwell) reduces
  effective availability vs. quasi-steady designs; no published target
...
AVAILABILITY = 0.80         # UNCERTAIN: pulsed operation (15+ min pulses + dwell for CS
                            # re-magnetisation) reduces effective capacity factor vs.
                            # steady-state.  No published target.
                            # Range applied in sensitivity: 0.70–0.90 per
                            # Araiinejad & Shirvan (2025) D-T MCF bracket, shifted
                            # to lower half; analysis.md §Section 2, Challenge 4
...
print(f"  Availability:                                  {AVAILABILITY:.0%}   [UNCERTAIN — no published target]")
