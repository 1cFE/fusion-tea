...
You are performing a data gap assessment for the fusion concept **HTS Tokamak - Full HTS (D-T)** (Energy Singularity) as preparation for a comprehensive qualitative and quantitative concept analysis.
...
- **Dossier**: `/home/reid/1cfe/fusion-tea/knowledge/concept_research/28-hts-tokamak-full-hts/dossier.md`
...
1. **Skim the index below first** to identify which fleet-wide sources are plausibly applicable to **HTS Tokamak - Full HTS (D-T)** (match on confinement family, fuel cycle, plant type, or cost-modeling scope).
