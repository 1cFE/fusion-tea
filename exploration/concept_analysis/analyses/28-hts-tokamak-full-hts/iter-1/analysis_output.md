...
| HH70 major radius | 0.75 m | dossier.md §Confinement Concept | high | Prototype |
| HH70 minor radius | ~0.25–0.31 m | dossier.md §Confinement Concept | medium | Estimated from aspect ratio |
...
| 12 | Regulatory framework for fusion power in China | S2 | not-yet-sourced | nice-to-have | Chinese regulatory agency publications; IAEA fusion regulatory guidance |
...
9. **ScienceDirect (2025)**: "Development and construction of magnet system for world's first full HTS tokamak"
   - Would provide engineering details on Jingtian magnet construction
   - Not incorporated due to paywall; data partially captured via secondary sources
