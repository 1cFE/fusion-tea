...
### G-1: No plant study for IMG architecture: all TEA data from Z-IFE LTD-era (2006) [SKIPPED]
...
### G-10: Thermal cycle above 900 K: high-temperature materials availability for He Brayton or combined cycle [PARTIAL]
...
### G-11: Pacific Fusion self-magnetizing target gain at 60+ MA (eliminates coils and laser) [PARTIAL]
...
### G-13: Laser preheat elimination: feasibility at commercially relevant yields [PARTIAL]
...
`/home/reid/1cfe/fusion-tea/exploration/concept_analysis/analyses/07-maglif/iter-8/research_output.json`
