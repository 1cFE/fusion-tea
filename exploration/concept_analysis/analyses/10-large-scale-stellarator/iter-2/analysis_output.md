...
| Divergence | DEMO/ARIES-AT | GIGA Stellarator | TEA Impact |
|-----------|---------------|-----------------|-----------|
| Current drive requirement | CS + NBI for current sustainment | None — rotational transform geometric | GIGA saves ~50–200 MW recirculating power; removes CS magnet cost |
| Operation mode | Pulsed (~75–80% CF) or long-pulse | Inherently steady-state (~85–90% CF) | +10–15% LCOE improvement for GIGA at constant capital cost |
| Disruption risk | Significant; forces PFC overdesign | Absent — disruption-free | GIGA avoids unplanned outage cost; lowers O&M uncertainty |
| Blanket geometry | ~2 unique segment shapes (in/outboard) | 80+ unique shapes across 3D surface | GIGA blanket fabrication more expensive; maintenance more complex |
| Machine scale | R ≈ 6–9 m (DEMO: 9 m, ARIES-AT: 5.2 m) | R = 18 m | GIGA coil system mass ~4–8× larger; dominant cost driver |
| Blanket component lifetime | 2.3 years at DEMO power | 4.6–9 years (HELIAS at lower avg. wall load) [helias-reactor-context.md §7] | Fewer replacement campaigns over plant life → lower blanket O&M cost |
| Coil geometry | 2D toroidal (manufacturable) | 3D non-planar modular (novel at scale) | GIGA bears additional manufacturing R&D cost vs. established tokamak coil practice |
