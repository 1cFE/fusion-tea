# Research Agent: Autonomous Source Acquisition for Large-Scale Stellarator
...
### G-2: Capacity factor target — no published source; requires Gauss Fusion disclosure or system code (PROCESS stellarator model) [PARTIAL]
- Iteration 2: searched "HELIAS stellarator power plant capacity factor availability PROCESS systems code", "Warmer HELIAS systems code availability factor capacity factor stellarator power plant economics 2015 2016"
  - Extracted: depositonce-bitstreams-39e36af5-b43a-4d14-b7fd-50c4e8b23aea (https://depositonce.tu-berlin.de/bitstreams/39e36af5-b43a-4d14-b7fd-50c4e8b23aea/download)
  - Failed: https://scipub.euro-fusion.org/wp-content/uploads/eurofusion/WPS2PR15_14259_submitted.pdf — add-source extraction failed (rc=1, no stderr) — likely server-side block or PDF fetch issue

### G-7: Realistic TBR with GIGA geometry gaps — full 3D MCNP calculation for GIGA geometry with 20 mm gaps and accurate segment shapes; idealistic (1.386) vs. realistic (1.15) gap is ~20% [PARTIAL]
- Iteration 2: searched "HELIAS blanket tritium breeding ratio MCNP 3D stellarator geometry gaps site:arxiv.org OR site:osti.gov", "HELIAS stellarator blanket neutronics tritium breeding ratio 3D MCNP OpenMC geometry realistic site:arxiv.org"
  - Extracted: arxiv-2512-08027v1 (https://arxiv.org/html/2512.08027v1)

### G-13: Segment 5 structural fix (current design fails RCC-MRx in accident loads) — helias-blanket-studies.md identifies failure; resolution (CP redesign or geometry change) not published [FAILED]
- Iteration 2: searched "HELIAS blanket segment structural analysis RCC-MRx accident loads nuclear design criteria"
...
```
uv run python scripts/run_analysis.py add-source 10 "<url>"
```
...
`/home/reid/1cfe/fusion-tea/exploration/concept_analysis/analyses/10-large-scale-stellarator/iter-3/research_output.json`
