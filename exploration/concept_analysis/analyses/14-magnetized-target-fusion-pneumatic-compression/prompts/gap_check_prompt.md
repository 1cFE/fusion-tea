...
- **Dossier**: `/home/reid/1cfe/fusion-tea/knowledge/concept_research/14-magnetized-target-fusion-pneumatic-compression/dossier.md`
...
1. **Skim the index below first** to identify which fleet-wide sources are plausibly applicable to **Magnetized Target Fusion - Pneumatic Compression (D-T)** (match on confinement family, fuel cycle, plant type, or cost-modeling scope).
