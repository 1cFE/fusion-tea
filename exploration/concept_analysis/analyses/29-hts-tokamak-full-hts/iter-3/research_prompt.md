# Research Agent: Autonomous Source Acquisition for HTS Tokamak - Full HTS
...
### G-12: Regulatory framework for fusion power in China [CLOSED]
- Iteration 2: searched "China fusion power regulatory framework nuclear regulation 2024 2025", "China NNSA fusion energy regulation "10 CFR" OR "regulatory framework" private fusion company 2024 2025"
  - Extracted: sciencedirect-science-article-pii-s2211467x25003839 (https://www.sciencedirect.com/science/article/pii/S2211467X25003839)

### G-13: HH70 commissioning paper (ScienceDirect, paywalled) — 'Design, commissioning, and first operation of HH70' in Fusion Engineering and Design 2025 [CLOSED]
- Iteration 2: searched "Energy Singularity HH70 tokamak commissioning "Fusion Engineering and Design" 2025", ""HH70" "full HTS" tokamak design commissioning site:sciencedirect.com OR site:doi.org 2025"
  - Extracted: sciencedirect-science-article-pii-s092037962500537x (https://www.sciencedirect.com/science/article/pii/S092037962500537X)
...
```
uv run python scripts/run_analysis.py add-source 28 "<url>"
```
...
`/home/reid/1cfe/fusion-tea/exploration/concept_analysis/analyses/28-hts-tokamak-full-hts/iter-3/research_output.json`
