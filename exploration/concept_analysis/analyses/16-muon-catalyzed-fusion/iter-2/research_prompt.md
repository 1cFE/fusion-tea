# Research Agent: Autonomous Source Acquisition for Muon-Catalyzed Fusion (D-T)
...
```
uv run python scripts/run_analysis.py add-source 16 "<url>"
```
...
`/home/reid/1cfe/fusion-tea/exploration/concept_analysis/analyses/16-muon-catalyzed-fusion/iter-2/research_output.json`
