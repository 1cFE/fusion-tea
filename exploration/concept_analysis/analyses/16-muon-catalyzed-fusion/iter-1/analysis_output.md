...
Alpha-sticking — the ~0.3–0.5% probability that a muon attaches to the alpha particle produced in a D-T fusion event, permanently removing it from the catalysis cycle — limits the maximum achievable fusions per muon:
...
Jackson's original 1957 estimate used ~1% sticking, yielding a ceiling of ~100 fusions per muon. More recent measurements at 0.3–0.5% sticking raise the ceiling to 200–350 fusions/muon [muon-catalyzed-fusion-physics.md §Problems facing practical exploitation]. Acceleron's 300 fusions/muon target sits near the top of this revised range, implying an operating regime with very low sticking probability sustained throughout the muon lifecycle. The sticking probability is not a freely adjustable engineering parameter — it is a function of the quantum mechanical muon transfer dynamics in the D-T plasma state. Any LCOE model must represent fusions/muon as a constrained physics parameter rather than a design variable.
...
| Alpha-sticking probability (recent measurements) | 0.3–0.5% | muon-catalyzed-fusion-physics.md §Problems facing practical exploitation | high | Improved from Jackson's original ~1% estimate; sets physics ceiling on fusions/muon |
| Alpha-sticking probability (Jackson 1957) | ~1% | muon-catalyzed-fusion-physics.md §Problems facing practical exploitation | high | Original estimate; implies ~100 fusions/muon ceiling; basis for "impractical as energy source" judgment |
...
**Nearest conceptual neighbors in the broader landscape**: No close structural neighbors exist in the current concept list. MCF is unique in using a particle accelerator as the primary driver. Distant structural analogues include heavy-ion beam ICF (`25-heavy-ion-beam-icf`) in that both rely on large particle accelerators as cost-dominant capital items, though the physics of energy deposition are completely different.
...
**5. Prior Approved Analysis: Spherical Tokamak - HTS (21-spherical-tokamak-hts)**
