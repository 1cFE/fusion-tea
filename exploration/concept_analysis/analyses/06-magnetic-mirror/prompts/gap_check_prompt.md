...
You are performing a data gap assessment for the fusion concept **Magnetic Mirror (p-B11)** (Pale Blue) as preparation for a comprehensive qualitative and quantitative concept analysis.
...
- **Dossier**: `/home/reid/1cfe/fusion-tea/knowledge/concept_research/06-magnetic-mirror/dossier.md`
...
1. **Skim the index below first** to identify which fleet-wide sources are plausibly applicable to **Magnetic Mirror (p-B11)** (match on confinement family, fuel cycle, plant type, or cost-modeling scope).
