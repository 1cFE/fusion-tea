# 1costingfe Model Setup: State-Backed Tokamak - BEST

You are generating a runnable 1costingfe model setup script for **State-Backed Tokamak - BEST**
(Neo Fusion).
...
## Output
Write the script to: `/home/reid/1cfe/fusion-tea/exploration/concept_analysis/analyses/33-state-backed-tokamak-best/iter-1/model_setup.py`
