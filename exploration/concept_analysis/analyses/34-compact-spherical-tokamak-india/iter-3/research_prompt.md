# Research Agent: Autonomous Source Acquisition for Compact Spherical Tokamak - India
...
### G-14: Jenga digital twin validation — no published outputs from Pranos Fusion's integrated simulation platform [PARTIAL]
- Iteration 2: searched "Pranos Fusion "Jenga" digital twin spherical tokamak preprint", "Pranos Fusion Shaurya Kaushal spherical tokamak arxiv 2025 2026", "Pranos Fusion arxiv 2025 2026 PRAGYA MAGGA tokamak paper"
  - Extracted: arxiv-2603-11549 (https://arxiv.org/abs/2603.11549)
...
```
uv run python scripts/run_analysis.py add-source 34 "<url>"
```
...
`/home/reid/1cfe/fusion-tea/exploration/concept_analysis/analyses/34-compact-spherical-tokamak-india/iter-3/research_output.json`
