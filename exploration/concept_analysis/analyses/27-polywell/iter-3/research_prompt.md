# Research Agent: Autonomous Source Acquisition for Polywell (D-T)
...
### G-11: Beam power supply efficiency at 78 MW scale — affects recirculating power fraction. Industrial electron beam supplier data; ~80–90% power supply efficiency is reasonable starting point. [FAILED]
- Iteration 2: searched "electron beam power supply efficiency 60 keV MW scale industrial", "high voltage electron beam gun power supply efficiency kW MW technical specifications", "Sciaky large electron beam power supply efficiency MW megawatt industrial vacuum metallurgy", ""electron beam" power supply efficiency percent "high power" OR "megawatt" OR "1 MW" 60keV site:osti.gov OR site:iaea.org", "industrial electron beam melting power supply efficiency "80%" OR "85%" OR "90%" high power gun wall-plug"
  - Failed: https://www.osti.gov/servlets/purl/1441166 — PDF content unreadable via WebFetch (binary-encoded, 8.8 MB). Could not verify whether DC electron gun efficiency data appears in body text. Technology (RF linac) is also not directly applicable to Polywell's DC injection guns.
...
`/home/reid/1cfe/fusion-tea/exploration/concept_analysis/analyses/27-polywell/iter-3/research_output.json`
