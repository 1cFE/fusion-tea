# Free-Form LCOE Model: Polywell (D-T)

You are building a standalone LCOE model for **Polywell (D-T)** (EMC2).
...
Follow the MagLIF exemplar's 5-layer structure adapted for Polywell (D-T):
...
## Output
Write the script to: `/home/reid/1cfe/fusion-tea/exploration/concept_analysis/analyses/27-polywell/iter-1/model_setup.py`
