...
ETA_TH_CONSERVATIVE = 0.40  # DEVIATION: canonical for Hybrid is 0.55, but Marvel hybrid 70% claim unvalidated; using conservative steam-only fallback per scoring_framework.md (Justified deviations).
