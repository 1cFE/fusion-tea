# 1costingfe Model Setup: QI Stellarator HTS (Proxima Fusion / Stellaris)

You are generating a runnable 1costingfe model setup script for **QI Stellarator HTS (Proxima Fusion / Stellaris)**
(Proxima Fusion). The script must run via `uv run python model_setup.py` and emit an
LCOE estimate.
...
**Start here.** Open `C:\Users\mallo\Deterministic_Concept_scoring\fusion-tea\exploration\concept_analysis\analyses\09-qi-stellarator-hts\analysis.md` and read its `## Design Point` block and
...
## Output
Write the script to: `C:\Users\mallo\Deterministic_Concept_scoring\fusion-tea\exploration\concept_analysis\analyses\09-qi-stellarator-hts\iter-1\model_setup.py`
