...
Modeling approach:
    ...
    (H2a) Higher-beta QI design: follow-on 4% beta scenario per CIEMAT-QI4X finding
        ...
        fusion power density scales down by ~31%, with proportional reductions in first wall
        area and blanket mass. H4-true ECRH assumption used. This is a scenario branch for
        next-generation QI designs, NOT a variant of the Stellaris v1 design point.
...
Key deviations from dt_tokamak.py reference:
    ...
    - iter-5 adds Scenario H2a (4% beta, smaller machine) per CIEMAT-QI4X finding.
"""
...
print(f"  LCOE: {c_h2a.lcoe:.1f} $/MWh | Overnight: {c_h2a.overnight_cost:.0f} $/kW")
print(f"  Fusion: {pt_h2a.p_fus:.0f} MW | Net: {pt_h2a.p_net:.0f} MW | Q_eng: {pt_h2a.q_eng:.1f}")
print(f"  LCOE delta vs. Scenario A: {c_h2a.lcoe - c_a.lcoe:+.1f} $/MWh")
...
11. Scenario H2a: Higher-beta QI design (4% beta) — iter-5 addition
