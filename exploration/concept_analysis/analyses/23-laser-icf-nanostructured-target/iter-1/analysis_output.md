...
| Laser optic replacement rate (10 Hz PW class) | not-yet-sourced | important | NIF optic damage studies are partial analogue but different regime |
...
| O&M cost basis (fixed + variable) | truly-unknown | important | No plant design from which to estimate staffing, maintenance schedule |
...
| 9 | Laser optic damage and replacement rate at 10 Hz petawatt class | S3, S5 | not-yet-sourced | important | NIF Annual Report optic damage sections; LLNL laser optics literature (imperfect analogue) |
