# Research Agent: Autonomous Source Acquisition for Compact Liquid-Wall HTS Stellarator
...
### G-4: Tritium breeding ratio (TBR) — fm = 1.24 confirmed; TBR not directly confirmed in available documents. Source recommendation: Read JNM 599 (2024) 155239 directly. [CLOSED]
- Iteration 2: searched "Li-LiH blanket tritium breeding ratio compact fusion stellarator "Journal of Nuclear Materials" 2024"
  - Extracted: infoscience-bitstreams-7d2d7b2f-6f75-4ac2-93cb-6eef8a65df82 (https://infoscience.epfl.ch/bitstreams/7d2d7b2f-6f75-4ac2-93cb-6eef8a65df82/download)

### G-11: REBCO film Jc at peak coil fields (20–40 T) at 20 K — needed to confirm feasibility of Renaissance Fusion's 20–40 T peak coil field range against REBCO critical current density at operating temperature. [CLOSED]
- Iteration 2: searched "REBCO critical current density Jc field dependence 20K high field 20 Tesla 30 Tesla superconductor", "REBCO coated conductor Jc 20K 20T 30T high field measurement arxiv OR osti.gov superconductor"
  - Extracted: arxiv-1512-01930 (https://arxiv.org/abs/1512.01930)

### G-7: Plasma parameters at ignition — confinement time, density, bootstrap fraction not published. Source recommendation: apply ISS04 stellarator energy confinement time scaling to design point. [PARTIAL]
- Iteration 2: searched "ISS04 stellarator energy confinement scaling law compact quasi-isodynamic plasma parameters", "Renaissance Fusion plasma confinement design parameters density bootstrap fraction quasi-isodynamic compact stellarator"
  - Failed: https://inis.iaea.org/collection/NCLCollectionStore/_Public/41/128/41128207.pdf — Extraction failed (rc=1, no stderr). IAEA PDF likely has access or format restrictions that blocked the extraction pipeline.
  - Failed: https://www.mdpi.com/2076-3417/12/6/2862 — Extraction failed (rc=1, no stderr). MDPI page may use JavaScript rendering that blocked extraction despite the article being open access.

### G-9: Peak Li-LiH outlet temperature — determines achievable sCO₂ turbine inlet temperature and confidence in 49–51% efficiency target. Expected to be in ECM paper (Fama et al. 2023). [PARTIAL]
- Iteration 2: searched (no queries)

### G-12: HTS cylinder count, dimensions, and total REBCO film area for full plant — required to estimate magnet system scale and film deposition demand. Not published. [FAILED]
- Iteration 2: searched "Renaissance Fusion plasma confinement design parameters density bootstrap fraction quasi-isodynamic compact stellarator"

### G-13: Cryogenic refrigeration power for full magnet system at 20 K — key contributor to recirculating power; not characterized in available sources. [FAILED]
- Iteration 2: searched "ISS04 stellarator energy confinement scaling law compact quasi-isodynamic plasma parameters"
...
```
uv run python scripts/run_analysis.py add-source 20b "<url>"
```
...
`/home/reid/1cfe/fusion-tea/exploration/concept_analysis/analyses/20b-renaissance-stellarator/iter-3/research_output.json`
