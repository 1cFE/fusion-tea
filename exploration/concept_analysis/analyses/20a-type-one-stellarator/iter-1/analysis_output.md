...
1. Thermal efficiency — implied ≈38–42% from published power balance but not explicitly stated
...
- With blanket multiplication M_b = 1.15: gross thermal = 800 × 1.15 = 920 MW
- Implied thermal efficiency = 415/920 ≈ 45%

A 45% efficiency would require a supercritical steam or sCO₂ cycle; the dossier characterizes the cycle as "Rankine with reheat, thermal efficiency > 30%." The "> 30%" lower bound is consistent with a wide range and the exact value materially affects LCOE. This is a derivable gap, not a fundamental unknown, but the derivation requires one or two unanchored assumptions.

**4. Island divertor performance at burning-plasma conditions (Impact: Moderate)**

Stellarators exhaust heat and particles through island divertors — magnetic islands at the plasma edge created by resonant field perturbations. Island divertors operate differently from tokamak divertors: there is no separatrix X-point; instead, heat flows along open field lines into elongated island chains that intercept divertor targets.

> "adequately sized island divertors to exhaust helium ash"
> — typeoneenergy-type-one-energy-issues-first-realistic.md

W7-X has demonstrated island divertor operation at power plant-relevant temperatures [referenced in dossier.md] but at far lower power density than a burning plasma. At 800 MW fusion, the heat loading on island divertor targets will be orders of magnitude higher than W7-X experiments. The divertor's ability to handle detached plasma operation at this power level — and the target material lifetime under these conditions — is not characterized. Island divertor capital and O&M cost is a distinct cost category from tokamak divertors and has no published cost estimate in the plant study literature.
...
**Island Divertor at Burning Plasma Power Level — TRL 3–4**

- **Demonstrated**: W7-X island divertor has operated successfully at stellarator research scale — demonstrating detachment, heat flux reduction, and helium ash exhaust [dossier.md; J. Plasma Phys. 2025 reference in dossier]. This is the world's only operating island divertor and provides genuine validation of the concept at plasma physics level.
- **On paper only**: Island divertor performance at burning plasma (Q > 40, 800 MW) heat and particle fluxes. Detachment control at heat fluxes likely exceeding 10 MW/m² average. Helium ash exhaust efficiency at the full throughput required for a burning plasma with no external current drive. Target geometry for the Infinity Two island divertor (not published).
- **Missing at scale**: Material selection and qualification for island divertor targets under fusion-relevant neutron flux + heat flux. Remote maintenance scheme for island divertor target exchange in Infinity Two geometry. Particle recycling model validated in a burning plasma environment. Divertor capital and O&M cost basis.
...
The HCPB solid breeder uses Li₄SiO₄ or Li₂TiO₃ pebble beds [dossier.md §Tritium Breeding]. These lithium ceramic pebbles require controlled sintering, pebble size distribution, and Li-6 enrichment. EU-DEMO has developed manufacturing processes for these pebbles at kilogram scale, but not at the multi-tonne scale required for a pilot plant blanket. The ceramics are fragile under irradiation-induced cracking and must be replaced on a neutron fluence schedule. Li-6 enrichment requirements depend on final blanket geometry — with TBR = 1.30 and Be multiplier, moderate enrichment may suffice, reducing supply chain pressure. Nevertheless, Li-6 enrichment capacity globally remains concentrated in Russia and China (legacy mercury amalgam processes; no Western industrial-scale alternative is yet operational) [handwritten exemplar 01-hts-compact-tokamak.md].

**Tritium (D-T Fuel) — Shared Constraint Across All D-T Concepts**
...
| Thermal efficiency (implied) | ~38–42% | [inferred: 800 MW fusion × 1.15 blanket multiplier = 920 MW thermal; 350 MWe net + ~65 MWe estimated recirculating = ~415 MWe gross; 415/920 ≈ 45%; range reflects recirculating uncertainty] | low | Derivable but not published; "Rankine with reheat, thermal efficiency > 30%" is the only public bound [dossier.md] |
...
| 13 | Li-6 enrichment level required for TBR = 1.30 with HCPB + Be multiplier | S4 | derivable | nice-to-have | Neutronics calculation determines Li-6 enrichment required; with Be multiplier, lower enrichment than bare Li₄SiO₄ likely sufficient; affects Li supply chain assessment |
...
4. Island divertor as the distinct heat exhaust system (different cost structure from tokamak divertor)
