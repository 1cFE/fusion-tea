...
| Repetition rate | ~10 Hz (900,000 shots/day) | focused-energy-callahan-interview.md §Rep rate | high | Commercial plant target; T-STAR at 1 shot/60 s currently |
...
| η_wp × G minimum for viability | >10 | osti-servlets-purl-2561299.md §Energetics | high | Fundamental IFE economic threshold; at 10% η_wp, requires G > 100 |
...
The handwritten exemplar for **26-laser-icf-indirect-drive** (Inertia Enterprises / Xcimer) provides the most directly relevant cross-concept data. Key divergences for fast ignition:
