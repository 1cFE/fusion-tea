# Research Agent: Autonomous Source Acquisition for Laser ICF - Indirect Drive (D-T)
...
### G-3: Capacity factor not modeled — no rep-rate-coupled availability analysis exists in available sources [PARTIAL]
- Iteration 2: searched "UKAEA PROCESS code IFE inertial fusion energy capacity factor availability model"
  - Extracted: pmc-articles-pmc7658748 (https://pmc.ncbi.nlm.nih.gov/articles/PMC7658748/)

### G-5: Target factory capital cost — GEM bottom-up model exists but not available; Goodin et al. 2004 cited as key reference [CLOSED]
- Iteration 2: searched "LLNL GEM generalized economics model inertial fusion target factory cost", "Goodin 2004 "target fabrication" "inertial fusion" factory cost site:osti.gov OR site:iaea.org OR site:arxiv.org"
  - Extracted: fire-fpa07-goodin-icf-fuel (https://fire.pppl.gov/fpa07_goodin_icf_fuel.pdf)

### G-9: O&M breakdown (fixed, variable, scheduled, unplanned) — no published IFE O&M model in available sources [PARTIAL]
- Iteration 2: searched "IFE inertial fusion energy power plant O&M operations maintenance cost LCOE breakdown"

### G-10: Tritium processing system design and cost — HYLIFE-III design study likely covers FLiBe tritium extraction [CLOSED]
- Iteration 2: searched "HYLIFE tritium extraction FLiBe molten salt tritium processing system cost inertial fusion"
  - Extracted: osti-biblio-10179076 (https://www.osti.gov/biblio/10179076)
...
`/home/reid/1cfe/fusion-tea/exploration/concept_analysis/analyses/26-laser-icf-indirect-drive/iter-3/research_output.json`
