...
You are performing a data gap assessment for the fusion concept **Laser ICF - Indirect Drive (D-T)** (Inertia Enterprises) as preparation for a comprehensive qualitative and quantitative concept analysis.
...
- **Dossier**: `/home/reid/1cfe/fusion-tea/knowledge/concept_research/26-laser-icf-indirect-drive/dossier.md`
...
1. **Skim the index below first** to identify which fleet-wide sources are plausibly applicable to **Laser ICF - Indirect Drive (D-T)** (match on confinement family, fuel cycle, plant type, or cost-modeling scope).
