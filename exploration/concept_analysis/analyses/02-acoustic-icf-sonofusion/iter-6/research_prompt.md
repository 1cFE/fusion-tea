# Research Agent: Autonomous Source Acquisition for Acoustic ICF / Sonofusion (D-D)
...
`/home/reid/1cfe/fusion-tea/exploration/concept_analysis/analyses/02-acoustic-icf-sonofusion/analysis.md`
...
### G-7: Acoustic driver power consumption at reactor scale — could be estimated from industrial ultrasonic transducer power specs at similar frequencies [CLOSED]
- Iteration 4: searched "industrial ultrasonic transducer power consumption specifications 20kHz 40kHz piezoelectric generator efficiency", "piezoelectric ultrasonic generator electro-acoustic efficiency percent power conversion site:arxiv.org OR site:osti.gov"
  - Extracted: americanpiezo-products-services-ultrasonic-power-transducers (https://www.americanpiezo.com/products-services/ultrasonic-power-transducers/)
  - Extracted: osti-pages-biblio-1224334 (https://www.osti.gov/pages/biblio/1224334)
  - Failed: https://www.sciencedirect.com/science/article/pii/S1350417723001505 — Extraction failed (rc=1) — ScienceDirect requires JavaScript rendering. Open-access content is not accessible via static extraction. No DOI redirect found to alternative host.
- Iteration 5: searched "high power ultrasonic processor system kW power consumption specifications industrial sonication Hielscher Branson", "acoustic cavitation reactor power density watts per liter sonochemistry scale-up industrial specifications site:arxiv.org OR site:osti.gov", "ultrasonic processor electro-acoustic efficiency wall-plug efficiency high power 20kHz piezoelectric transducer measurements percent", "Hielscher ultrasonics power specifications frequency efficiency datasheet comparison UIP16000 UIP4000 kW"
  - Extracted: hielscher-i16000-p (https://www.hielscher.com/i16000_p.htm)
  - Extracted: hielscher-uip4000hdt-4kw-high-performance-ultrasonics (https://www.hielscher.com/uip4000hdt-4kw-high-performance-ultrasonics.htm)

### G-14: Deuterium fuel cost and supply chain for commercial scale — D₂O pricing from nuclear industry; deuterium gas market pricing [CLOSED]
- Iteration 4: searched "heavy water D2O price per kilogram nuclear industry deuterium fuel cost 2024 2025", "heavy water deuterium oxide production cost CANDU reactor supply chain site:world-nuclear.org OR site:iaea.org OR site:osti.gov", "heavy water D2O cost price per kg world nuclear association deuterium oxide nuclear fuel"
  - Extracted: wits-trade-comtrade-en-country-all-year-2023-tradeflow (https://wits.worldbank.org/trade/comtrade/en/country/ALL/year/2023/tradeflow/Exports/partner/WLD/product/284510)
...
```
uv run python scripts/run_analysis.py add-source 02 "<url>"
```
...
`/home/reid/1cfe/fusion-tea/exploration/concept_analysis/analyses/02-acoustic-icf-sonofusion/iter-6/research_output.json`
