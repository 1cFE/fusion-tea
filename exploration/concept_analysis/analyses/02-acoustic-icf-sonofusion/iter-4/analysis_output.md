...
3. **Driver efficiency floor.** The acoustic driver's recirculating power fraction sets a hard efficiency floor on net electrical output. Commercial PZT transducers at 28–50 kHz have electromechanical coupling Kp ≥ 55% (APC International Model 90-4040 datasheet; `americanpiezo-products-services-ultrasonic-power-transducers.md`); practical wall-plug efficiency is higher but unspecified in open literature. Reducing the recirculating power fraction — rather than marginal improvements in transducer coupling — has the most LCOE leverage. This creates an engineering design target for driver architecture.
...
| Transducer electromechanical coupling (Kp) | ≥55% | americanpiezo-products-services-ultrasonic-power-transducers.md §Product Specifications | medium | APC International Model 90-4040 at 28 kHz; Qm = 800. Practical wall-plug efficiency higher but unspecified in open literature. |
