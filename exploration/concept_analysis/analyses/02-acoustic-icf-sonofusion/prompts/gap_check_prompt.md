...
You are performing a data gap assessment for the fusion concept **Acoustic ICF / Sonofusion (D-D)** (Sonofusion Energy) as preparation for a comprehensive qualitative and quantitative concept analysis.
...
- **Dossier**: `/home/reid/1cfe/fusion-tea/knowledge/concept_research/02-acoustic-icf-sonofusion/dossier.md`
...
1. **Skim the index below first** to identify which fleet-wide sources are plausibly applicable to **Acoustic ICF / Sonofusion (D-D)** (match on confinement family, fuel cycle, plant type, or cost-modeling scope).
