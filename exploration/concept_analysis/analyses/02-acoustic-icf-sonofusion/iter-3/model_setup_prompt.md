# Free-Form LCOE Model: Acoustic ICF / Sonofusion (D-D)

You are building a standalone LCOE model for **Acoustic ICF / Sonofusion (D-D)** (Sonofusion Energy).
...
## Output
Write the script to: `/home/reid/1cfe/fusion-tea/exploration/concept_analysis/analyses/02-acoustic-icf-sonofusion/iter-3/model_setup.py`
