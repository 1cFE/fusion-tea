# 1costingfe Model Setup: Laser ICF - Hybrid Direct Drive (D-T)

You are generating a runnable 1costingfe model setup script for **Laser ICF - Hybrid Direct Drive (D-T)**
(Xcimer Energy).
...
## Output
Write the script to: `/home/reid/1cfe/fusion-tea/exploration/concept_analysis/analyses/17a-laser-icf-hybrid-drive/iter-6/model_setup.py`
