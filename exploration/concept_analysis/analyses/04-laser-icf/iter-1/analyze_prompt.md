...
4. **Dossier** (structured research summary — your factual foundation): `C:\Users\mallo\Deterministic_Concept_scoring\fusion-tea\knowledge\concept_research\04-laser-icf\dossier.md`
5. **Extracted Source Documents** (use subagents — see Per-Source Reading Pattern).
   ...
   - `C:\Users\mallo\Deterministic_Concept_scoring\fusion-tea\knowledge\concept_research\04-laser-icf\iter-01\sources\hb11-company-overview.md` (1 KB)
...
`C:\Users\mallo\Deterministic_Concept_scoring\fusion-tea\exploration\concept_analysis\analyses\04-laser-icf\iter-1\analysis_body.md`
