...
overrides = [
    ...
    # CAS21: Buildings — eliminated tritium/hot-cell infrastructure
    {
        ...
        "rationale": (
            "CAS21 is a Class-S (shared/fixed) account: the library charges it "
            "once for the fleet regardless of n_mod — that single charge is the "
            "amortization that gives a small module a fair shot at 1 GWe. "
            "0.50× means 50% of the library's default once-charged building cost "
            "for a fleet of this laser-ICF module at 1 GWe. "
