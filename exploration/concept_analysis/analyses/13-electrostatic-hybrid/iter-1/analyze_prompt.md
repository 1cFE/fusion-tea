...
4. **Dossier** (structured research summary — your factual foundation): `C:\Users\mallo\Deterministic_Concept_scoring\fusion-tea\knowledge\concept_research\13-electrostatic-hybrid\dossier.md`
5. **Extracted Source Documents** (use subagents — see Per-Source Reading Pattern).
   ...
   - `C:\Users\mallo\Deterministic_Concept_scoring\fusion-tea\knowledge\concept_research\13-electrostatic-hybrid\iter-01\sources\avalanche-29m-raise-2026.md` (6 KB)
...
`C:\Users\mallo\Deterministic_Concept_scoring\fusion-tea\exploration\concept_analysis\analyses\13-electrostatic-hybrid\iter-1\analysis_body.md`
