# Research Agent: Autonomous Source Acquisition for Electrostatic Hybrid (D-T)
...
### G-11: Measured scaling from 100 kV (Physics of Plasmas paper) to 300 kV operating point [PARTIAL]
- Iteration 2: searched "arxiv "mode-enhanced ion loading" "100 kV orbitrap" Physics of Plasmas Avalanche Energy", "arxiv "Orbitron" "crossed-field" "co-confinement" "AIP Advances" Avalanche Energy electrostatic fusion", "site:osti.gov "mode-enhanced ion loading" "100 kV orbitrap" OR "orbitrap" "Merthe" Avalanche Energy fusion", "arxiv.org "Merthe" OR "Hakimi" "orbitrap" OR "Orbitron" "Avalanche Energy" fusion 100 kV ion loading preprint"
  - Extracted: osti-pages-servlets-purl-2582151 (https://www.osti.gov/pages/servlets/purl/2582151)
  - Extracted: ui-2023aps-dpptp1006m-abstract (https://ui.adsabs.harvard.edu/abs/2023APS..DPPTP1006M/abstract)
  - Extracted: ui-2023aps-dppyo8010l-abstract (https://ui.adsabs.harvard.edu/abs/2023APS..DPPYO8010L/abstract)
  - Failed: https://pubs.aip.org/aip/pop/article/32/9/092105/3362035/Mode-enhanced-ion-loading-in-a-100-kV-orbitrap — AIP Publishing institutional paywall — no open-access version found on OSTI (DOE funding not confirmed for this paper) or arXiv (no preprint deposited)
...
```
uv run python scripts/run_analysis.py add-source 13 "<url>"
```
...
`/home/reid/1cfe/fusion-tea/exploration/concept_analysis/analyses/13-electrostatic-hybrid/iter-3/research_output.json`
