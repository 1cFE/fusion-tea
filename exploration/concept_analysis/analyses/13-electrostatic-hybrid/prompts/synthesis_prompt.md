...
You are producing an editorial synthesis for the fusion concept **Electrostatic Hybrid (Orbitron)**
...
### 1. Reviewed Analysis
`C:\Users\mallo\Deterministic_Concept_scoring\fusion-tea\exploration\concept_analysis\analyses\13-electrostatic-hybrid\analysis.md`

### 2. Model Setup and Output

`C:\Users\mallo\Deterministic_Concept_scoring\fusion-tea\exploration\concept_analysis\analyses\13-electrostatic-hybrid\model_setup.py`


Model output (user-generated): `C:\Users\mallo\Deterministic_Concept_scoring\fusion-tea\exploration\concept_analysis\analyses\13-electrostatic-hybrid\model_output.txt`
...
Write to: `C:\Users\mallo\Deterministic_Concept_scoring\fusion-tea\exploration\concept_analysis\analyses\13-electrostatic-hybrid\synthesis_body.md`
