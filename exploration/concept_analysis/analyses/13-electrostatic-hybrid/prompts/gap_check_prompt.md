...
You are performing a data gap assessment for the fusion concept **Electrostatic Hybrid (D-T)** (Avalanche Energy) as preparation for a comprehensive qualitative and quantitative concept analysis.
...
- **Dossier**: `/home/reid/1cfe/fusion-tea/knowledge/concept_research/13-electrostatic-hybrid/dossier.md`
...
1. **Skim the index below first** to identify which fleet-wide sources are plausibly applicable to **Electrostatic Hybrid (D-T)** (match on confinement family, fuel cycle, plant type, or cost-modeling scope).
