...
4. **Dossier** (structured research summary — your factual foundation): `C:\Users\mallo\Deterministic_Concept_scoring\fusion-tea\knowledge\concept_research\31-laser-icf-oec-architecture\dossier.md`
5. **Extracted Source Documents** (use subagents — see Per-Source Reading Pattern).
   ...
   - `C:\Users\mallo\Deterministic_Concept_scoring\fusion-tea\knowledge\concept_research\31-laser-icf-oec-architecture\iter-01\sources\blf-website-and-news.md` (2 KB)
...
`C:\Users\mallo\Deterministic_Concept_scoring\fusion-tea\exploration\concept_analysis\analyses\31-laser-icf-oec-architecture\iter-1\analysis_body.md`
