...
projects Q~100 from an undemonstrated plasmonic field-enhancement mechanism. An
additional anomaly — the paper reports 3333 MeV/event (standard D-D: ~3.65 MeV) —
casts further doubt on the Q claim. Every BLOCKING unknown below is a structural
absence in the public record, not a measurement uncertainty.
...
Critical unresolved gaps (analysis.md §Section 6):
  ...
  [BLOCKING] Resolution of anomalous 3333 MeV/event energy figure
...
assumptions = [
    ...
    ("Q-factor (plasma)",
     "~100 (paper claim)",
     "SPECULATIVE / ANOMALOUS",
     "arXiv:2503.15531 — also reports 3333 MeV/event (standard D-D: ~3.65 MeV)."),
