# Research Agent: Autonomous Source Acquisition for PoloMac Magnetic Confinement
...
```
uv run python scripts/run_analysis.py add-source 35 "<url>"
```
...
`/home/reid/1cfe/fusion-tea/exploration/concept_analysis/analyses/35-polomac-magnetic-confinement/iter-3/research_output.json`
