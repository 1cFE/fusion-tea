# 1costingfe Model Setup: Spherical Tokamak - CS-free p-B11 (p-B11)

You are generating a runnable 1costingfe model setup script for **Spherical Tokamak - CS-free p-B11 (p-B11)**
(ENN Energy).
...
## Output
Write the script to: `/home/reid/1cfe/fusion-tea/exploration/concept_analysis/analyses/39-spherical-tokamak-cs-free-p-b11/iter-1/model_setup.py`
