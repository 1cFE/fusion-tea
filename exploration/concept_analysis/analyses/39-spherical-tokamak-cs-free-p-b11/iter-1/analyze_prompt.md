...
4. **Dossier** (structured research summary — your factual foundation): `C:\Users\mallo\Deterministic_Concept_scoring\fusion-tea\knowledge\concept_research\39-spherical-tokamak-cs-free-p-b11\dossier.md`
5. **Extracted Source Documents** (use subagents — see Per-Source Reading Pattern).
   ...
   - `C:\Users\mallo\Deterministic_Concept_scoring\fusion-tea\knowledge\concept_research\39-spherical-tokamak-cs-free-p-b11\iter-01\sources\enn-pb11-spherical-torus-roadmap.md` (2 KB)
...
`C:\Users\mallo\Deterministic_Concept_scoring\fusion-tea\exploration\concept_analysis\analyses\39-spherical-tokamak-cs-free-p-b11\iter-1\analysis_body.md`
