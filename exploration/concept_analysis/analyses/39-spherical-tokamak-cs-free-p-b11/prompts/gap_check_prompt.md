...
You are performing a data gap assessment for the fusion concept **Spherical Tokamak - CS-free p-B11 (p-B11)** (ENN Energy) as preparation for a comprehensive qualitative and quantitative concept analysis.
...
- **Dossier**: `/home/reid/1cfe/fusion-tea/knowledge/concept_research/39-spherical-tokamak-cs-free-p-b11/dossier.md`
...
- `/home/reid/1cfe/fusion-tea/knowledge/concept_research/39-spherical-tokamak-cs-free-p-b11/iter-01/sources/enn-pb11-spherical-torus-roadmap.md` (2 KB)
...
1. **Skim the index below first** to identify which fleet-wide sources are plausibly applicable to **Spherical Tokamak - CS-free p-B11 (p-B11)** (match on confinement family, fuel cycle, plant type, or cost-modeling scope).
