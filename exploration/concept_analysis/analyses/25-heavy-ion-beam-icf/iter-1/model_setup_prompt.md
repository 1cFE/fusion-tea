# 1costingfe Model Setup: Heavy-Ion Beam ICF

You are generating a runnable 1costingfe model setup script for **Heavy-Ion Beam ICF**
(Intensity Energy). The script must run via `uv run python model_setup.py` and emit an
LCOE estimate.
...
**Start here.** Open `C:\Users\mallo\Deterministic_Concept_scoring\fusion-tea\exploration\concept_analysis\analyses\25-heavy-ion-beam-icf\analysis.md` and read its `## Design Point` block and
...
## Output
Write the script to: `C:\Users\mallo\Deterministic_Concept_scoring\fusion-tea\exploration\concept_analysis\analyses\25-heavy-ion-beam-icf\iter-1\model_setup.py`
