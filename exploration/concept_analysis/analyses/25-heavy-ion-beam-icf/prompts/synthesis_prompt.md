# Synthesis: Heavy-Ion Beam ICF

You are producing an editorial synthesis for the fusion concept **Heavy-Ion Beam ICF**
(Intensity Energy). Your role is to INTERPRET, JUDGE, and PRIORITIZE — not to document.
...
### 1. Reviewed Analysis
`C:\Users\mallo\Deterministic_Concept_scoring\fusion-tea\exploration\concept_analysis\analyses\25-heavy-ion-beam-icf\analysis.md`

### 2. Model Setup and Output

`C:\Users\mallo\Deterministic_Concept_scoring\fusion-tea\exploration\concept_analysis\analyses\25-heavy-ion-beam-icf\model_setup.py`


Model output (user-generated): `C:\Users\mallo\Deterministic_Concept_scoring\fusion-tea\exploration\concept_analysis\analyses\25-heavy-ion-beam-icf\model_output.txt`
...
Write to: `C:\Users\mallo\Deterministic_Concept_scoring\fusion-tea\exploration\concept_analysis\analyses\25-heavy-ion-beam-icf\synthesis_body.md`
