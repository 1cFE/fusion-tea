...
# Availability is the dominant LCOE lever (elasticity ≈ −0.96). H2 hypothesis:
# if plant availability stays above ~78%, LCOE remains below $100/MWh.
# No published HYLIFE-II availability target; 0.80 is an analogue-based assumption.
# This sweep directly tests the commercial viability threshold.
# Source: analysis §S2 Challenge 3; analysis §S5 (H2 hypothesis)
_avail_scenarios = [
    (0.70, "Low availability   (70%)"),
    (0.75, "Below-target       (75%)"),
    (0.80, "Base case          (80%)"),
...
for _avail, _label in _avail_scenarios:
    ...
    _note = "  <- base case" if abs(_avail - 0.80) < 0.001 else ""
...
print("  H2 hypothesis (analysis §S5): LCOE < $100/MWh requires availability > ~78%.")
