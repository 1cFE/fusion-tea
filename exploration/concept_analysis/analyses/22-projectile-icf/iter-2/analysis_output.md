...
**C220111 — Reactor-equipment installation & assembly**: The library computes C220111 as 14% of the reactor equipment subtotal. However, it applies this fraction to the *pre-override* subtotal ($13,247M, dominated by the generic C220104 = $12,591M), producing an installation cost of $1,854.6M — more than 9× the post-override driver cost it is notionally installing. After overrides reduce C220104 from $12,591M to $200M and C220107 from $420M to $0, the physically meaningful installation cost should scale from the *post-override* reactor subtotal (~$363M), giving 14% × $363.3M ≈ $51M.
...
```yaml
  - account: C220111
    ...
    enabled: true
    provenance: derived
    source: "model_output.txt §CAS22 sub-account detail"
    rationale: |
      The library computes C220111 as 14% of the pre-override reactor subtotal ($13,247M),
      producing $1,854.6M. But overrides reduce the reactor equipment from $13,247M to
      ~$363.3M (C220104: $12,591M → $200M; C220107: $420M → $0; C220108: $79M → $5.6M).
      Installation labor should scale with the equipment being installed, not the generic
      reference. 14% × $363.3M = $50.9M ≈ $51M. Without this correction, installation
      labor exceeds the driver it installs by 9×, inflating native LCOE from ~$170/MWh
      to $312/MWh.
```
...
Total override entries: 8 (C220101, C220102, C220104, C220107, C220108, C220110, C220111, CAS27).
Enabled overrides: 7 (C220102, C220104, C220107, C220108, C220110, C220111, CAS27).
...
The count of 7 enabled overrides falls within the expected band. Four overrides (C220104, C220107, C220108, CAS27) are grounded in company-published cost data or peer-reviewed parametric analysis. Three overrides (C220102, C220110, C220111) are derived corrections for structural mismatches between the HEAVY_ION archetype defaults and the liquid-lithium-curtain, sub-Hz, EM-gun architecture. The C220111 override corrects a material library artifact where installation labor ($1,855M) exceeds the post-override equipment it installs ($363M) by 5×.
...
| **Installation (C220111)** | Scaled from reactor equipment subtotal | Must scale from post-override subtotal ($363M, not $13,247M) | **Correction** — override $51M vs. generic $1,855M (library artifact) |
...
### Supplementary Cross-Concept Context
