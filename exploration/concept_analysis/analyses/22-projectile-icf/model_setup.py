...
overrides = [
    ...
    # C220108: Target factory — annualized target manufacturing cost
    {
        ...
        "rationale": (
            ...
            "Library default ($79.1M for high-rep-rate IFE target factory) is inapplicable "
            "at 1M/year volume. Actual cost is unknown — the model carries the value as "
            "a placeholder replacing a clearly wrong default, not as an engineering estimate."
        ),
        "cost_basis": "noak",
    },
