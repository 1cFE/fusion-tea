# Free-Form LCOE Model: Dense Plasma Focus (p-B11)

You are building a standalone LCOE model for **Dense Plasma Focus (p-B11)** (LPPFusion).
...
Follow the MagLIF exemplar's 5-layer structure adapted for Dense Plasma Focus (p-B11):
