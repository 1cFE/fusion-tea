...
Snapshot: 2026-04-11. 38 concepts from `exploration/concept_explorer/data/concept_registry.json`.

**Columns:**
- **Iter** — number of `iter-N/` directories under `exploration/concept_analysis/analyses/{id}-*/`
...
|-----|------|---------|-----:|-------------|------------|-----------|----------|
| 01  | HTS Compact Tokamak | Commonwealth Fusion Systems | 7 | stale | yes | stale | no |
...
| 15  | Sheared-Flow Stabilized Z-Pinch | Zap Energy | 4 | stale | no | yes | no |
| 16  | Muon-Catalyzed Fusion (D-T) | Acceleron Fusion | 0 | no | - | no | no |
| 17a | Laser ICF - Hybrid Direct Drive (D-T) | Xcimer Energy | 7 | stale | yes | yes | no |
...
| 22  | Projectile ICF (D-T) | First Light Fusion, NearStar Fusion | 5 | stale | no | yes | no |
...
| 28  | HTS Tokamak - Full HTS | Energy Singularity | 3 | stale | yes | yes | no |
...
| 35  | PoloMac Magnetic Confinement | Deutelio | 2 | stale | no | no | no |
| 36  | Helical Coil Stellarator | Helical Fusion | 0 | no | - | no | no |

## Summary

- Total concepts: **38**
- Analysis started (`iter-N/` present): **19**
- `model_setup.py` present: **19** (8 fresh, 11 stale)
- Using `1costingfe` framework: **14** (of 19); the other 5 use hand-built models
- Extracted to explorer data: **18** (1 stale)
- Approved: **1**
