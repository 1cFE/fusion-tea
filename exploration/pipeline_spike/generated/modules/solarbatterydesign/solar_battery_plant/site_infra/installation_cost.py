...
SysML Source: unknown:0
    ...
    IMPLEMENTATION: See solar_battery_tea.handwritten.solarbatterydesign.solar_battery_plant.site_infra.installation_cost_impl
    ...
    def run(
        ...
        from solar_battery_tea.handwritten.solarbatterydesign.solar_battery_plant.site_infra.installation_cost_impl import (
