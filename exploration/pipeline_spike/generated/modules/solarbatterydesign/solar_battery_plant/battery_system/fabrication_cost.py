...
SysML Source: unknown:0
    ...
    IMPLEMENTATION: See solar_battery_tea.handwritten.solarbatterydesign.solar_battery_plant.battery_system.fabrication_cost_impl
    ...
    def run(
        ...
        from solar_battery_tea.handwritten.solarbatterydesign.solar_battery_plant.battery_system.fabrication_cost_impl import (
