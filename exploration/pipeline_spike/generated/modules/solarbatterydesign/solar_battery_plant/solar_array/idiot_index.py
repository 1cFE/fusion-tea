...
Handwritten implementation required in handwritten/solarbatterydesign/solar_battery_plant/solar_array/idiot_index_impl.py
"""
...
SysML Source: unknown:0
    ...
    IMPLEMENTATION: See solar_battery_tea.handwritten.solarbatterydesign.solar_battery_plant.solar_array.idiot_index_impl
    ...
    def run(
        ...
        from solar_battery_tea.handwritten.solarbatterydesign.solar_battery_plant.solar_array.idiot_index_impl import (
            run_idiot_index,
        )
