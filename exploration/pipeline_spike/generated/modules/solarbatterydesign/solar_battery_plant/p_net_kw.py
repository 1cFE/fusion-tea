...
SysML Source: unknown:0
    ...
    IMPLEMENTATION: See solar_battery_tea.handwritten.solarbatterydesign.solar_battery_plant.p_net_kw_impl
    ...
    def run(
        ...
        from solar_battery_tea.handwritten.solarbatterydesign.solar_battery_plant.p_net_kw_impl import (
            run_p_net_kw,
        )
