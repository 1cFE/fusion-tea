...
from solar_battery_tea.schemas.permittingcostcalc_output import PermittingCostCalcOutput
...
SysML Source: solar_battery_model/library.sysml:210
    ...
    Calculation Specification:
        cost_per_kw = LiteralRationalEvaluation()
        material_cost = LiteralRationalEvaluation()
        fab_cost = LiteralRationalEvaluation()
        install_cost = LiteralRationalEvaluation()
        total_cost = system_capacity_kw * cost_per_kw
        idiot_index = LiteralRationalEvaluation()
...
*Last Updated**: 2026-02-01
    ...
    IMPLEMENTATION: See solar_battery_tea.handwritten.solarbatterylibrary.permittingcostcalc_impl
    ...
    def run(
        ...
        from solar_battery_tea.handwritten.solarbatterylibrary.permittingcostcalc_impl import (
