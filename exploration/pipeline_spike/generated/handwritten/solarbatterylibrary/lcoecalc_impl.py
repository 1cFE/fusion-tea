from solar_battery_tea.modules.solarbatterylibrary.lcoecalc import LCOECalcInput
...
SysML Source: solar_battery_model/library.sysml:335
...
Example:
    ...
    Implementation Pattern:
        ...
        annualized_capital_cost = inputs.annualized_capital_cost
        annual_om_cost = inputs.annual_om_cost
        annual_fuel_cost = inputs.annual_fuel_cost
        yearly_inflation = inputs.yearly_inflation
        plant_lifetime = inputs.plant_lifetime
        annual_energy_mwh = inputs.annual_energy_mwh
