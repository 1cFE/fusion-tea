...
│   └── parameter_index.json   # Cross-concept parameter index (for US-14)
├── templates/
...
# 3. Build manifest.json from all ConceptData summaries
# 4. Build parameter_index.json across all concepts with sensitivity data
