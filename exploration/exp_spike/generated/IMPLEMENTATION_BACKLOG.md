...
3. Open the corresponding `*_impl.py` file in `exp_toy_tea/handwritten/`
...
6. Test: `python -c "from exp_toy_tea.modules.<module> import <Module>"`
...
|--------|--------|----------|--------------|------------|
| [ ] | BoschHaleReactivity | `run_boschhalereactivity` | `models/exp_toy.sysml:39` | High |
| [ ] | GainDoublings | `run_gaindoublings` | `models/exp_toy.sysml:53` | Low |
...
**Instructions**:
1. Create a test pipeline configuration in `exp_toy_tea/pipelines/`
