...
from solar_battery.schemas.annualizedfinancialcalc_output import AnnualizedFinancialCalcOutput
...
*Last Updated**: 2026-02-01
    ...
    IMPLEMENTATION: See solar_battery.handwritten.solarbatterylibrary.annualizedfinancialcalc_impl
    ...
    def run(
        ...
        from solar_battery.handwritten.solarbatterylibrary.annualizedfinancialcalc_impl import (
