from solar_battery.modules.solarbatterylibrary.hybridinvertercostcalc import HybridInverterCostCalcInput
...
Example:
    ...
    raise NotImplementedError(
        "Manual implementation required for HybridInverterCostCalc. "
        "See SysML source: models/tests/solar_battery/library.sysml:119"
    )
