...
class LibraryParams(BaseModel):
    ...
    SolarBatteryLibrary__Racking_&_Mounting__cost_model__panel_count: float = Field(description="Entry point: panel_count")
    SolarBatteryLibrary__Racking_&_Mounting__cost_model__tilt_angle: float = Field(description="Entry point: tilt_angle")
    SolarBatteryLibrary__Electrical_Panel__cost_model__circuit_count: float = Field(description="Entry point: circuit_count")
    SolarBatteryLibrary__Permitting_&_Interconnect__cost_model__system_capacity_kw: float = Field(description="Entry point: system_capacity_kw")
    ...
    SolarBatteryLibrary__Racking_&_Mounting__cost_model__cost_per_panel_rack: float = Field(default=57.0, description="Entry point: cost_per_panel_rack")
    SolarBatteryLibrary__Racking_&_Mounting__cost_model__fab_factor: float = Field(default=0.45, description="Entry point: fab_factor")
    SolarBatteryLibrary__Racking_&_Mounting__cost_model__install_factor: float = Field(default=0.3, description="Entry point: install_factor")
    ...
    SolarBatteryLibrary__Permitting_&_Interconnect__cost_model__cost_per_kw: float = Field(default=187.5, description="Entry point: cost_per_kw")
