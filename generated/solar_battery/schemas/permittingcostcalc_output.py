...
SysML Source: models/tests/solar_battery/library.sysml:210
    """
    material_cost: float = Field(default=0.0, description="material_cost output")
    fab_cost: float = Field(default=0.0, description="fab_cost output")
    install_cost: float = Field(default=0.0, description="install_cost output")
    total_cost: float = Field(description="total_cost output")
    idiot_index: float = Field(default=0.0, description="idiot_index output")
