...
SysML Source: models/tests/e2e_attr_expr/library.sysml:39
    ...
    IMPLEMENTATION: See e2e_attr_expr_v5.handwritten.e2eattrexprlibrary.simplelcoecalc_impl
    ...
    def run(
        ...
        from e2e_attr_expr_v5.handwritten.e2eattrexprlibrary.simplelcoecalc_impl import (
            run_simplelcoecalc,
        )
