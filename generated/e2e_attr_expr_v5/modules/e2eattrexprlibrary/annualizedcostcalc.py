...
from e2e_attr_expr_v5.schemas.annualizedcostcalc_output import AnnualizedCostCalcOutput
...
SysML Source: models/tests/e2e_attr_expr/library.sysml:19
    ...
    Calculation Specification:
        crf = discount_rate * LiteralRationalEvaluation() + discount_rate ** lifetime / LiteralRationalEvaluation() + discount_rate ** lifetime - LiteralRationalEvaluation()
        annualized_cost = crf * total_capex

    IMPLEMENTATION: See e2e_attr_expr_v5.handwritten.e2eattrexprlibrary.annualizedcostcalc_impl
    ...
    def run(
        ...
        from e2e_attr_expr_v5.handwritten.e2eattrexprlibrary.annualizedcostcalc_impl import (
