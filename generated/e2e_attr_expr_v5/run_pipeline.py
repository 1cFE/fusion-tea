#!/usr/bin/env python3
"""Execute the e2e_attr_expr_v5 TEAx pipeline.

V5: Clean regeneration — no workarounds. Bug 11/12 fix validation.

Usage:
    PYTHONPATH=generated uv run python generated/e2e_attr_expr_v5/run_pipeline.py
"""
from pathlib import Path

from simkit.core.pipeline import execute_pipeline
from e2e_attr_expr_v5 import create_e2e_attr_expr_v5_registry, CUSTOM_SCHEMA_TYPES
...
def main():
    ...
    registry = create_e2e_attr_expr_v5_registry()
