...
SysML Expression: quantity * unit_cost / 1000000.0
    ...
    IMPLEMENTATION: See e2e_attr_expr_v2.handwritten.e2eattrexprdesign.e2e_plant.power_mw_impl
    ...
    def run(
        ...
        from e2e_attr_expr_v2.handwritten.e2eattrexprdesign.e2e_plant.power_mw_impl import (
