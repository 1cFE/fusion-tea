...
SysML Expression: length * width * height
    ...
    IMPLEMENTATION: See e2e_attr_expr_v2.handwritten.e2eattrexprdesign.e2e_plant.volume_impl
    ...
    def run(
        ...
        from e2e_attr_expr_v2.handwritten.e2eattrexprdesign.e2e_plant.volume_impl import (
