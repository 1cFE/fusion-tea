...
SysML Source: models/tests/e2e_attr_expr/library.sysml:31
    ...
    Calculation Specification:
        annual_energy_mwh = 8760.0 * power_mw * availability

    IMPLEMENTATION: See e2e_attr_expr_v2.handwritten.e2eattrexprlibrary.energycalc_impl
    ...
    def run(
        ...
        from e2e_attr_expr_v2.handwritten.e2eattrexprlibrary.energycalc_impl import (
            run_energycalc,
        )
