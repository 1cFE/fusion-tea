...
SysML Expression: p_net_mw * 1000.0
    ...
    IMPLEMENTATION: See solar_battery_v2.handwritten.solarbatterydesign.solar_battery_plant.p_net_kw_impl
    ...
    def run(
        ...
        from solar_battery_v2.handwritten.solarbatterydesign.solar_battery_plant.p_net_kw_impl import (
