...
3. Open the corresponding `*_impl.py` file in `solar_battery_v2/handwritten/`
...
6. Test: `python -c "from solar_battery_v2.modules.<module> import <Module>"`
...
**Instructions**:
1. Create a test pipeline configuration in `solar_battery_v2/pipelines/`
