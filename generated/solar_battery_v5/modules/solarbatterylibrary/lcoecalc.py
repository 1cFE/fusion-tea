...
*Last Updated**: 2026-02-01
    ...
    IMPLEMENTATION: See solar_battery_v5.handwritten.solarbatterylibrary.lcoecalc_impl
    ...
    def run(
        ...
        from solar_battery_v5.handwritten.solarbatterylibrary.lcoecalc_impl import (
            run_lcoecalc,
        )
