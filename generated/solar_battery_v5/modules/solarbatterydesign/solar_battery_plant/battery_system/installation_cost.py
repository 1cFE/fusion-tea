...
SysML Source: unknown:0
    ...
    IMPLEMENTATION: See solar_battery_v5.handwritten.solarbatterydesign.solar_battery_plant.battery_system.installation_cost_impl
    ...
    def run(
        ...
        from solar_battery_v5.handwritten.solarbatterydesign.solar_battery_plant.battery_system.installation_cost_impl import (
