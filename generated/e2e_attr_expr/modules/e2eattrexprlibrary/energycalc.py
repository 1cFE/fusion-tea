...
SysML Source: models/tests/e2e_attr_expr/library.sysml:31
    ...
    IMPLEMENTATION: See e2e_attr_expr.handwritten.e2eattrexprlibrary.energycalc_impl
    ...
    def run(
        ...
        from e2e_attr_expr.handwritten.e2eattrexprlibrary.energycalc_impl import (
            run_energycalc,
        )
