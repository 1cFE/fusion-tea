...
SysML Expression: area * cost_per_sqm
    ...
    IMPLEMENTATION: See e2e_attr_expr.handwritten.e2eattrexprdesign.e2e_plant.surface_cost_impl
    ...
    def run(
        ...
        from e2e_attr_expr.handwritten.e2eattrexprdesign.e2e_plant.surface_cost_impl import (
