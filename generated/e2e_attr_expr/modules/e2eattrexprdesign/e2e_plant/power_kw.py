...
SysML Expression: power_mw * 1000.0
    ...
    IMPLEMENTATION: See e2e_attr_expr.handwritten.e2eattrexprdesign.e2e_plant.power_kw_impl
    ...
    def run(
        ...
        from e2e_attr_expr.handwritten.e2eattrexprdesign.e2e_plant.power_kw_impl import (
