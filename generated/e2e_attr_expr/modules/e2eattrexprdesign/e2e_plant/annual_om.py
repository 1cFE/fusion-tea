...
SysML Expression: om_rate * power_kw
    ...
    IMPLEMENTATION: See e2e_attr_expr.handwritten.e2eattrexprdesign.e2e_plant.annual_om_impl
    ...
    def run(
        ...
        from e2e_attr_expr.handwritten.e2eattrexprdesign.e2e_plant.annual_om_impl import (
