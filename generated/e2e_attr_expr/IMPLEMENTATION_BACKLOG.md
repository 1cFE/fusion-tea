...
3. Open the corresponding `*_impl.py` file in `e2e_attr_expr/handwritten/`
...
6. Test: `python -c "from e2e_attr_expr.modules.<module> import <Module>"`
...
**Instructions**:
1. Create a test pipeline configuration in `e2e_attr_expr/pipelines/`
