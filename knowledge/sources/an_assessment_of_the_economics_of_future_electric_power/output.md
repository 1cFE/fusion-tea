...
This page is blank — no visible text, figures, tables, or other content to extract.
...
This page is blank (Roman numeral page viii — no content to extract).
...
This page is blank (no content to extract).
...
Cost of money factors, % _Capitalization_ _Cost of Money_
Debt 47 7.4 (4.27) _[a]_

Preferred stock 6 6.9 (3.79) _[a]_
Common equity 47 12.0 (8.74) _[a]_


Cost of money during construction, % 9.53 (6.34) _[a]_
Effective cost of money (discount rate), % 8.18 (5.02) _[a]_
...
projections [2 ] show inflation increasing to 2020. The rate exceeds 3% in the later years. We assume
...
in the EPRI-TAG [TM] escalated to 1999 dollars and scaled to the plant sizes considered. The
PC-FGD costs are for a two-unit, 600 MW(e) per unit plant. The PFBC plant costs are for a threeunit, 400 MW(e) per unit plant, and the GCC investment costs are for a two-unit, 600 MW(e) per
unit plant. The CCCT plant is also based on information in the EPRI TAG [TM] . The CCCT cost
model in this paper assumes a four-unit plant with a unit capacity of 300 MW(e). Base construction costs for the PC-FGD and PFBC plants are shown in Table 2. The base construction cost for
...
| Account | Capital investment cost \n_____________________________________ PC-FGD \nUnits × [MW(e) \n2 × 600 | (1999 $M) \nPFBC \nper unit] \n3 × 400 |
| --- | --- | --- |
| _________________________________________________________________________ Land and land rights | 2 | 2 |
| Steam generator | 563 | 552 |
| Turbine generator | 339 | 204 |
| Coal handling equipment | 119 | 108 |
| Balance of plant | 120 | 218 |
| Environmental capital | 207 | 0 |
| General facilities and engineering | 187 | 202 |
| Base construction cost | 1538 [1282 $/kW(e)] | 1287 [1072 $/kW(e)] |
| Range, $/kW(e) | 800–1350 | 800–1180 |
...
Cost models for the ALWR nuclear plants were derived from the same basic cost information used in the 1992 USCEA study. [10] This information is for an evolutionary reactor with a unit
...
The ALMR capital costs are consistent with reported information. [11,] [22] This information for
...
| --- | --- |
| ______________________________________________________________ Land and land rights | 2 |
| Air separation | 172 |
| Gasification/gas cooling | 412 |
| Gas cleanup | 50 |
| Combined cycle | 523 |
...
| Account | Capital investment cost (1999 $M) |
| --- | --- |
| _______________________________________________________________ Land and land rights | 1 |
| Combustion turbine and auxiliaries | 193 |
| Heat recovery steam generator | 78 |
| Steam turbine, generator, and auxiliaries | 73 |
| General facilities and engineering | 245 |
...
cost model was derived from the EPRI/DOE Renewable Energy Characterization TC Study. [16]
...
100-MW(e) station considered here. [16] There are economies of scale with station size. Larger size
...
designs are shown in Table 7. The ARIES power plant studies [17,18] are referenced here because
they use a costing methodology consistent with other costs in this paper. There are also
studies [19,20] for IFE for which the costing approach differs. These IFE studies show lower costs
...
| Account \n_______________________________________________________________________ | Capital (1999 \n_______________________________________ ALWR Units × [MW(e) 1 × 1300 | investment cost $M) \nALMR per unit] 3 × 496 |
| --- | --- | --- |
| Land and land rights Structures and | 5 339 | 5 360 |
| improvements Reactor plant equipment | 349 | 865 |
| Turbine plant equipment | 331 | 263 |
| Electric plant equipment | 97 | 115 |
| Miscellaneous plant equipment | 63 | 39 |
| Heat rejection system | 70 | 38 |
...
Heat rejection system _b_ 69.5
...
| Account | Capital investment cost (1999 $M) |
| --- | --- |
| ___________________________________________________________ Land and land rights | 1 |
| Rotor assembly | 14.1 |
| Tower | 23.7 |
| Generator | 4.1 |
| Electrical | 6.6 |
...
| Account | Construction (1999 $M) \n_______________________________________ ARIES-RS | costa \nARIES-ST |
| --- | --- | --- |
| ________________________________________________________________________________ Land and land rights | 5 | 5 |
| Structures and improvements | 399.7 | 432.3 |
| Reactor plant equipment | 1600.0 | 1534.9 |
| Turbine plant equipment | 344.2 | 410.5 |
| Electric plant equipment | 130.4 | 147.9 |
...
| 2345 | 2038 1835 | 2650 | 2263 \n295 387 | 1728 \nALWR 240 | Table 8. \nNuclear |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  |  |  |  |  | Total |  |  |  |  |
| 2630 | 2105 1835 | 3132 | 406 2734 398 | ALMR 2063 264 | fission |  |  |  |  |
|  |  |  |  |  | capitalized |  |  |  |  |
| 670 | 615 580 | 738 | 61 668 70 | CCCT 590 17 | Gas |  |  |  |  |
| 920 _______________________________________________________________________________________________________ | 755 620 |  |  | ______________________________________________________________________________________________________ | cost ______________________________________________________________________________________________________ |  |  |  |  |
|  |  | 75.5 | 6.5 71.7 3.8 | Wind 65.2 a | Renewable |  |  |  |  |
|  |  | 4947 | 4225 | ARIES-RS |  |  |  |  |  |
...
| Plant type | Fixed cost [$/kW(e) per year] | Variable cost (mill/kWh) | O&M costa (mill/kWh) |
| --- | --- | --- | --- |
| _____________________________________________________________________ ALWR | 57.6 | 0.4 | 8.6 |
| ALMR | 70.2 | 0.4 | 10.4 |
| PC-FGD coal | 36.7 | 3.2 | 8.5 |
| PFBC | 36.8 | 2.0 | 7.2 |
| GCC—coal gasification | 54.8 | 1.6 | 9.4 |
...
|  | 1999 \nReference | dollars \nRange |
| --- | --- | --- |
| ______________________________________________________________ Nuclear fuel prices |  |  |
| Uranium, $/lb U3O8 | 25 | 15–145 |
| Conversion, $/kg uranium | 7 | 4–7 |
| Enrichment, $/SWU | 80 | 40–100 |
| Low-enriched uranium (LEU) |  |  |
...
[Figure 1: Historic cost of coal to electric utilities. Line graph showing Average Coal Cost ($/MBtu) on the y-axis (0 to 3.0) versus Year on the x-axis (1980 to 1998). Values are in January 1999 Dollars. The trend shows a steady decline from approximately $2.5/MBtu in 1980–1983 to approximately $1.3/MBtu in 1998. ORNL 99-1407 EFG]

[Figure 2: Price paid by electric utilities for natural gas. Line graph showing Average Natural Gas Cost ($/MBtu) on the y-axis (0 to 6) versus Year on the x-axis (1980 to 1998). Values are in January 1999 Dollars. The trend shows a rise from approximately $4.3/MBtu in 1980 to a peak of approximately $5.6/MBtu in 1982–1984, followed by a sharp decline to approximately $3.3/MBtu by 1987, then relatively stable values between $2.5–$3.2/MBtu through 1998. ORNL 99-1408 EFG]
...
O&M 8.5      7.2       9.4       4.5      8.6     10.4     4.6     9.0 _[c]_ 9.0 _[c]_
Fuel 9.4      8.1       8.1      26.6      5.6      8.8            5.4 _[d       ]_ 3.8 _[d]_
...
_f_ Range for fusion includes capacity factor range (70%–90%) and plant size range [1000–1300 MW(e)].

| costs range \nin | CCCT \n48.6 30–65 plant | 26.6 8.7 | CCCT 8.8 4.5 | Levelized COE |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| source | is |  |  |  |  |  |  |  |  |
| [1000–1300 |  |  |  | (1999$ |  |  |  |  |  |
| document. | 44.7 38–62 included | 5.6 0.8 | ALWR 29.7 8.6 | COE |  |  |  |  |  |
| MW(e)]. | to |  |  | mill/kWh) |  |  |  |  |  |
|  | obtain |  |  |  |  |  |  |  |  |
|  | 51.3 45–62 | 8.8 1.5 | ALMR 30.6 10.4 |  |  |  |  |  |  |
|  | reference |  |  |  |  |  |  |  |  |
...
[Figure 11: Range of COE for concepts without carbon sequestration. Bar chart showing COE (mill/kWh) ranges for six energy concepts in January 1999 Dollars with 2050 Plant Startup Date. PFBC: ~33–45; GCC: ~38–55; CCCT: ~30–52; Wind: ~20–50; Fission: ~30–62; Fusion: ~75–97, with reference parameter lines marked for ALMR and ALWR at approximately 42 and 40 mill/kWh respectively. ORNL 99-1417 EFG]

[Figure 12: Range of COE for concepts including carbon sequestration. Bar chart showing COE (mill/kWh) ranges for six energy concepts in January 1999 Dollars with 2050 Plant Startup Date. PFBC: ~40–75; GCC: ~42–78; CCCT: ~30–65; Wind: ~20–50; Fission: ~30–62; Fusion: ~75–97, with reference parameter lines marked for ALMR and ALWR at approximately 50 and 48 mill/kWh respectively. ORNL 99-1418 EFG]
...
5. T. R. Curlee 29–33. J. Sheffield
6–15. J. G. Delene 34. R. B. Shelton
16. E. C. Fox 35–39. K. A. Williams
17. R. G. Gilliland 40. D. L. Williams, Jr.
...
CA 94550
48. W. D. Magwood IV, NE-1, U.S. Department of Energy, Forrestal Bldg., Room 5A-143,
1000 Independence Avenue SW, Washington, DC 20585
49. R. W. Miller, University of California–San Diego, 9599 Gilman Drive, La Jolla, CA 920930417
50. R. Moir, Lawrence Livermore National Laboratory, P.O. Box 808, L-637, Livermore, CA
94550
51. F. Najmabadi, 6291 Boelter Hall, University of California, Los Angeles, CA 90024
52. J. M. Stamos, NE-20, U.S. Department of Energy, 19901 Germantown Rd., Room B-406,
Germantown, MD 20874
