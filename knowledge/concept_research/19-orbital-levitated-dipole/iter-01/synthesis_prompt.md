# Dossier Synthesis: Orbital Levitated Dipole (D-He3)
...
1. **Current dossier**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/19-orbital-levitated-dipole/dossier.md`
   (Does not exist yet — you will create it from scratch.)
   

2. **New research**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/19-orbital-levitated-dipole/iter-01/output.md`
...
Write the complete dossier to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/19-orbital-levitated-dipole/dossier.md` using the structure below. This OVERWRITES the previous dossier — include all information, not just changes.
...
Append the following to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/19-orbital-levitated-dipole/changelog.md`:
...
- **Concept Name**: Orbital Levitated Dipole (D-He3)
- **Company**: Zephyr Fusion
...
- **Lab Experiments**: LDX (MIT/Columbia, ended), RT-1 (University of Tokyo)
