# Dossier Synthesis: Sheared-Flow Stabilized Z-Pinch (D-T)
...
1. **Current dossier**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/15-sheared-flow-stabilized-z-pinch/dossier.md`
   (Does not exist yet — you will create it from scratch.)
   

2. **New research**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/15-sheared-flow-stabilized-z-pinch/iter-01/output.md`
...
Write the complete dossier to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/15-sheared-flow-stabilized-z-pinch/dossier.md` using the structure below. This OVERWRITES the previous dossier — include all information, not just changes.
...
Append the following to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/15-sheared-flow-stabilized-z-pinch/changelog.md`:
...
- **Lab Experiments**: FuZE (University of Washington), ZaP (UW), Sandia Z Machine (Z-pinch variant)
