# Dossier Synthesis: Projectile ICF (D-T)
...
1. **Current dossier**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/22-projectile-icf/dossier.md`
   
   (Read this file. It contains the current best knowledge.)

2. **New research**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/22-projectile-icf/iter-02/output.md`
...
Write the complete dossier to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/22-projectile-icf/dossier.md` using the structure below. This OVERWRITES the previous dossier — include all information, not just changes.
...
Append the following to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/22-projectile-icf/changelog.md`:
