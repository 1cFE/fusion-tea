# Dossier Synthesis: Magnetic Mirror (D-T)
...
1. **Current dossier**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/11-magnetic-mirror/dossier.md`
   (Does not exist yet — you will create it from scratch.)
   

2. **New research**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/11-magnetic-mirror/iter-01/output.md`
...
Write the complete dossier to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/11-magnetic-mirror/dossier.md` using the structure below. This OVERWRITES the previous dossier — include all information, not just changes.
...
Append the following to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/11-magnetic-mirror/changelog.md`:
...
- **Concept Name**: Magnetic Mirror (D-T)
- **Company**: Realta Fusion
...
- **Lab Experiments**: WHAM (UW-Madison), GDT (Budker Institute), TMX (LLNL, ended), GAMMA-10 (Tsukuba)
