# Dossier Synthesis: Compact Spherical Tokamak - India (D-T)
...
1. **Current dossier**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/34-compact-spherical-tokamak-india/dossier.md`
   (Does not exist yet — you will create it from scratch.)
   

2. **New research**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/34-compact-spherical-tokamak-india/iter-01/output.md`
...
Write the complete dossier to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/34-compact-spherical-tokamak-india/dossier.md` using the structure below. This OVERWRITES the previous dossier — include all information, not just changes.
...
Append the following to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/34-compact-spherical-tokamak-india/changelog.md`:
...
- **Concept Name**: Compact Spherical Tokamak - India (D-T)
- **Company**: Pranos Fusion
...
- **Lab Experiments**: SST-1 (IPR Gandhinagar), Aditya-U (IPR)
