# Fusion Concept Research: p-B11 FRC (p-B11)
...
- **Name**: p-B11 FRC (p-B11)
- **Company**: TAE Technologies
- **Confinement approach**: Magnetic Confinement
- **Description**: Field-reversed configuration optimized for proton-boron-11 aneutronic fuel. Near-unity beta FRC with neutral beam injection for plasma heating and current drive. Truly aneutronic (<1% neutrons) eliminates tritium breeding blanket, heavy shielding, and remote handling. Requires extreme confinement performance (150-300 keV). Direct energy conversion potential.
...
1. **Start broad**: Search the web for "TAE Technologies fusion technology" and similar queries. Look for the company's website, Wikipedia page, Fusion Industry Association profile, press releases, and investor presentations.
...
- **Confidence**: high
- **Citation**: iter-01/sources/grokipedia-tae-technologies.md; TAE 2025 NBI breakthrough press release
- **Notes**: TAE's proprietary approach. 2025 breakthrough demonstrated FRC formation exclusively through NBI without plasma guns or formation coils. C-2W/Norman parameters: separatrix radius 0.4 m, axial length 2 m, plasma current 300-350 kA, trapped flux ~16 mWb.

### Fuel
- **Value**: p-B11
- **Confidence**: high
- **Citation**: Baseline CSV; iter-01/sources/grokipedia-tae-technologies.md
...
- **Value**: NBI
- **Confidence**: high
- **Citation**: iter-01/sources/tae-nbi-breakthrough-2025.md; Nature Communications 2025
- **Notes**: Eight injectors on Norm machine delivering 13 MW total power. High-energy neutral deuterium atoms injected tangentially. NBI serves quadruple duty: plasma formation, heating, current drive, and momentum-based stabilization. The 2025 NBI-only formation breakthrough eliminates all auxiliary formation hardware.

### Energy Capture
- **Value**: Direct (charged particle)
- **Confidence**: medium
- **Citation**: iter-01/sources/tae-energy-conversion-notes.md; Patent US7459654 (Tri Alpha Energy / UC / UF)
- **Notes**: Long-term vision is Inverse Cyclotron Converter (ICC): tapering magnetic field decelerates 3 MeV alpha particles past segmented electrodes, inducing AC at ~5 MHz under 0.6 T fields, targeting >90% conversion efficiency. HOWEVER, TAE's public FAQ describes thermal steam conversion, and a New Atlas interview suggests Da Vinci may initially use steam turbines with direct conversion as a future upgrade. A third speculative approach ("X-ray to DC solid-state capture") was mentioned in an interview. The near-term/long-term distinction is the biggest unresolved tension in this dossier.

### Plasma State
- **Value**: Sustained
- **Confidence**: high
- **Citation**: iter-01/sources/grokipedia-tae-technologies.md
...
- **Value**: Resistive
- **Confidence**: medium
- **Citation**: iter-01/sources/grokipedia-tae-technologies.md ("External copper coils for equilibrium/mirror field")
- **Notes**: FRC is primarily self-confined by plasma currents (near-unity beta). External copper coils provide equilibrium and mirror fields on C-2W. Reactor magnet technology not explicitly confirmed — could potentially upgrade to HTS for reactor-scale, but no public statements to this effect. The minimal external field requirements (FRC beta ~1) mean magnet technology is less critical than for tokamaks/stellarators.

### Tritium Breeding
- **Value**: N/A (aneutronic)
- **Confidence**: high
- **Citation**: Schema definition; baseline CSV
...
- **Confidence**: high
- **Citation**: Schema definition; baseline CSV description
...
- **Confidence**: high
- **Citation**: iter-01/sources/grokipedia-tae-technologies.md; iter-01/sources/tae-nbi-breakthrough-2025.md
- **Notes**: NBI is TAE's core technology bet. Eight injectors at 13 MW total on Norm. The 2025 breakthrough — NBI-only FRC formation without plasma guns — is the key innovation enabling the simplified Da Vinci reactor design. TAE holds 1,600+ patents. Over $1.3B in private capital raised.

## Remaining Gaps

1. **Energy Capture (medium confidence)**: Three competing narratives (ICC direct conversion, thermal/steam, X-ray solid-state). Need authoritative source on Da Vinci's baseline design choice. A TAE technical publication or investor presentation specifying the power conversion architecture would resolve this. Another iteration targeting TAE's technical papers or DOE ARPA-E reports could help.

2. **Magnet Type (medium confidence)**: Copper/resistive confirmed for C-2W experimental machine, but reactor-scale magnet choice is unconfirmed. TAE technical publications on Da Vinci design or ARPA-E milestone reports might clarify. However, given FRC's near-unity beta, external magnets are a secondary system — this gap is lower priority.

3. **Plasma State**: While "Sustained" is correct and high-confidence for the current approach, TAE's ultimate goal of high-Q p-B11 operation could shift this toward "Burning" if they achieve ignition-like conditions. This is a future evolution, not a current gap.

## Key Sources

1. **Grokipedia - TAE Technologies** — iter-01/sources/grokipedia-tae-technologies.md (comprehensive overview of machine history, parameters, technology)
2. **TAE NBI Breakthrough Press Release & Nature Communications 2025** — iter-01/sources/tae-nbi-breakthrough-2025.md; https://www.nature.com/articles/s41467-025-58849-5
3. **TAE Energy Conversion Notes** — iter-01/sources/tae-energy-conversion-notes.md (documents the ICC vs thermal conversion tension)
4. **TAE FAQ** — https://tae.com/faq-fusion/
5. **Patent US7459654** — Inverse Cyclotron Converter (Tri Alpha Energy / UC / UF)
