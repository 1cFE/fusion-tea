# Dossier Synthesis: p-B11 FRC (p-B11)
...
1. **Current dossier**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/18-p-b11-frc/dossier.md`
   (Does not exist yet — you will create it from scratch.)
   

2. **New research**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/18-p-b11-frc/iter-01/output.md`
...
Write the complete dossier to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/18-p-b11-frc/dossier.md` using the structure below. This OVERWRITES the previous dossier — include all information, not just changes.
...
Append the following to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/18-p-b11-frc/changelog.md`:
...
- **Fuel Type**: p-B11 (Proton-Boron-11)
- **Operation Mode**: Continuous
- **Published Machine/Plant?**: No
- **Lab Experiments**: C-2W Norman (TAE/UCI), FRX-L (LANL), TCS (UW), LSX (STI)
