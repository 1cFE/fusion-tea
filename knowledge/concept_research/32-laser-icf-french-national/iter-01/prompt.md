# Fusion Concept Research: Laser ICF - French National (D-T)
...
- **Name**: Laser ICF - French National (D-T)
...
1. **Start broad**: Search the web for "GenF Systems fusion technology" and similar queries. Look for the company's website, Wikipedia page, Fusion Industry Association profile, press releases, and investor presentations.
