# Dossier Synthesis: Laser ICF - French National (D-T)
...
1. **Current dossier**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/32-laser-icf-french-national/dossier.md`
   (Does not exist yet — you will create it from scratch.)
   

2. **New research**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/32-laser-icf-french-national/iter-01/output.md`
...
Write the complete dossier to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/32-laser-icf-french-national/dossier.md` using the structure below. This OVERWRITES the previous dossier — include all information, not just changes.
...
Append the following to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/32-laser-icf-french-national/changelog.md`:
...
- **Concept Name**: Laser ICF - French National (D-T)
- **Company**: GenF Systems
- **Confinement Approach**: Inertial Confinement
- **Description**: Laser-driven ICF. Spin-off from Thales Group. Leading TARANIS project with CNRS and CEA. Winner of France 2030 program. Targeting 1000 MW power plant by 2050.
- **Fuel Type**: D-T (Deuterium-Tritium)
- **Operation Mode**: Pulsed
- **Published Machine/Plant?**: No
- **Lab Experiments**: LMJ (CEA), PETAL (CEA)
