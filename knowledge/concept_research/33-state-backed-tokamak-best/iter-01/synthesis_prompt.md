# Dossier Synthesis: State-Backed Tokamak - BEST (D-T)
...
1. **Current dossier**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/33-state-backed-tokamak-best/dossier.md`
   (Does not exist yet — you will create it from scratch.)
   

2. **New research**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/33-state-backed-tokamak-best/iter-01/output.md`
...
Write the complete dossier to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/33-state-backed-tokamak-best/dossier.md` using the structure below. This OVERWRITES the previous dossier — include all information, not just changes.
...
Append the following to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/33-state-backed-tokamak-best/changelog.md`:
...
- **Concept Name**: State-Backed Tokamak - BEST (D-T)
- **Company**: Neo Fusion
...
- **Lab Experiments**: EAST (ASIPP), HL-2M (SWIP)
