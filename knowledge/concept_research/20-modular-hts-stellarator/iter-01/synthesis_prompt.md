# Dossier Synthesis: Modular HTS Stellarator (D-T)
...
1. **Current dossier**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/20-modular-hts-stellarator/dossier.md`
   (Does not exist yet — you will create it from scratch.)
   

2. **New research**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/20-modular-hts-stellarator/iter-01/output.md`
...
Write the complete dossier to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/20-modular-hts-stellarator/dossier.md` using the structure below. This OVERWRITES the previous dossier — include all information, not just changes.
...
Append the following to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/20-modular-hts-stellarator/changelog.md`:
...
- **Concept Name**: Modular HTS Stellarator (D-T)
- **Company**: Type One Energy, Renaissance Fusion
...
- **Lab Experiments**: Wendelstein 7-X (IPP Greifswald), HSX (UW-Madison), LHD (NIFS Japan)
