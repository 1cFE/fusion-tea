...
source_type: "url"
extracted_at: "2026-04-20T18:24:58.235646+00:00"
...
![](images/tmpazbkmhpw.pdf-0001-01.png)
...
![Fig. 1.1. Essential functions of the tritium breeding blanket](images/tmpazbkmhpw.pdf-0006-00.png)

![Fig. 1.2. Schematic of level inputs and outputs of the TBB.](images/tmpazbkmhpw.pdf-0006-02.png)
...
![Fig. 1.3. Schematic of the power core of tokamak power plant indicating the location of the TBB (adapted from mpg.de)](images/tmpazbkmhpw.pdf-0007-00.png)
...
![](images/tmpazbkmhpw.pdf-0008-04.png)
...
![](images/tmpazbkmhpw.pdf-0008-06.png)

![](images/tmpazbkmhpw.pdf-0008-07.png)
...
![Fig. 3.1 Function boundary of the TBB showing primary inputs and outputs.](images/tmpazbkmhpw.pdf-0013-03.png)

![Fig. 3.2  Context diagram indicating Active and Passive Stakeholders.](images/tmpazbkmhpw.pdf-0013-05.png)
...
![Fig. 3.3 Schematic of the HCLL TBB module.](images/tmpazbkmhpw.pdf-0014-04.png)

![Fig. 3.4.  More detail concept illustration of the PbLi TBB module (from A. Li Puma et al, “Design and Development of DEMO Blanket Concepts in Europe,” ISFNT-11, Barcelona, Spain, 9-17-14)](images/tmpazbkmhpw.pdf-0015-00.png)
...
![Fig. 5.1 Block diagram illustrating key components involved in start-up of the TBB.](images/tmpazbkmhpw.pdf-0017-00.png)
...
![Fig. 7.1 Schematic of DCLL configuration showing how the SiC flow channel insert is positioned in the PbLi coolant/breeding region (from N. Morley, FPA meeting, 10/11/2005)](images/tmpazbkmhpw.pdf-0024-03.png)

![Fig. 7.2.  A more detail diagram showing the internal configuration of the DCLL TBB using FCI (from N. Morley, FPA meeting, 10/11/2005).](images/tmpazbkmhpw.pdf-0024-05.png)
