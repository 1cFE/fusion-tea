# Fusion Concept Research: HTS Tokamak - Full HTS (D-T)
...
- **Name**: HTS Tokamak - Full HTS (D-T)
- **Company**: Energy Singularity
- **Confinement approach**: Magnetic Confinement
- **Description**: World's first full HTS tokamak (HH70). Achieved 1,337-second steady-state plasma in Feb 2026. Based in Shanghai. Building next-gen Honghuang 170 targeting demo power station ~2030.
...
1. **Start broad**: Search the web for "Energy Singularity fusion technology" and similar queries. Look for the company's website, Wikipedia page, Fusion Industry Association profile, press releases, and investor presentations.
...
Energy Singularity is a Shanghai-based company building the world's first fully HTS tokamak — all toroidal field, poloidal field, and central solenoid coils use REBCO high-temperature superconductor. Their prototype HH70 achieved a 1,337-second steady-state plasma in February 2026. Their Jingtian prototype magnet reached 21.7 T peak field, surpassing the CFS/MIT 20 T record. The next machine, HH170 (Honghuang 170), targets Q > 10 at ~110% of SPARC field strength in ~70% of SPARC volume, with completion expected by 2027. The demo power station HH380 is planned post-2030.
...
- **Confidence**: high
- **Citation**: Research iter-01 — HH170 is ~70% of SPARC volume with higher field
- **Notes**: Full HTS enables compact design. All coils (TF, PF, CS) are REBCO — unique among tokamak concepts.

### Fuel
- **Value**: D-T
- **Confidence**: high
- **Citation**: Baseline CSV; confirmed by research
- **Notes**: Standard deuterium-tritium fuel cycle.

### Primary Heating
- **Value**: RF (ICRH)
- **Confidence**: medium
- **Citation**: Research iter-01 — ICRF confirmed on HH70
- **Notes**: ICRH confirmed on the HH70 prototype. Heating plan for HH170 and production machines not publicly disclosed; may differ from prototype.

### Energy Capture
- **Value**: Thermal (unspecified)
- **Confidence**: medium
- **Citation**: Research iter-01 — standard D-T inference
- **Notes**: No company-specific disclosure. Inferred from D-T fuel cycle (14.1 MeV neutrons require thermal conversion). HH380 engineering details not yet public.
...
- **Value**: HTS (wound)
- **Confidence**: high
- **Citation**: Research iter-01 — Jingtian magnet 21.7 T peak field, REBCO
- **Notes**: Distinguishing feature: ALL coils (TF, PF, CS) are REBCO HTS. Jingtian prototype magnet achieved 21.7 T peak field. Most other HTS tokamak concepts use HTS for TF coils only.

### Tritium Breeding
- **Value**: TBD
- **Confidence**: high (that it's TBD)
- **Citation**: Research iter-01 — no public disclosure found
- **Notes**: No blanket technology disclosed. As a D-T concept, tritium breeding is required but the approach is unknown.

### Neutron Management
- **Value**: Heavy shielding (14 MeV)
- **Confidence**: medium
- **Citation**: Research iter-01 — physics-based inference from D-T fuel
- **Notes**: Inferred from D-T fuel cycle producing 14.1 MeV neutrons. No company-specific shielding design disclosed. Could be upgraded to `Integrated blanket/shield` if blanket details emerge.

### Operation Mode
- **Value**: Steady-state
- **Confidence**: high
- **Citation**: Baseline CSV; confirmed by HH70 achieving 1,337-second steady-state plasma (Feb 2026)
- **Notes**: Long-pulse steady-state demonstrated on prototype.
...
### Driver Technology
- **Value**: HTS magnets (REBCO, 22+ T)
- **Confidence**: high
- **Citation**: Research iter-01 — Jingtian magnet 21.7 T demonstrated; HH170 targets higher
- **Notes**: Full HTS coil set (TF + PF + CS) is the key technology differentiator. 22+ T reflects HH170 target capability beyond the 21.7 T Jingtian demonstration.

## Remaining Gaps

| Column | Current State | What's Been Searched | Potential Resolution |
|--------|--------------|---------------------|---------------------|
| Primary Heating | Medium — HH70 ICRH confirmed, HH170 plan unknown | General web research | ScienceDirect commissioning paper; Chinese-language publications on HH170 design |
| Energy Capture | Medium — generic D-T inference | General web research | HH380 engineering publications if/when released |
| Plasma State | Medium — based on Q > 10 target | General web research | HH170 physics design papers |
| Tritium Breeding | TBD — complete blank | General web research | Chinese-language technical reports; conference proceedings |
| Neutron Management | Medium — physics inference only | General web research | HH170/HH380 engineering design publications |

Another iteration could help if it targets the ScienceDirect HH70 commissioning paper and Chinese-language technical publications from Energy Singularity.

## Key Sources

1. Research iteration 1 output (iter-01/output.md) — web research on Energy Singularity, HH70, HH170, Jingtian magnet
2. Baseline concept CSV — initial company/concept identification
