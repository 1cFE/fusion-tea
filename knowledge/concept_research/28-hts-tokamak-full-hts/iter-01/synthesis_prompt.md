# Dossier Synthesis: HTS Tokamak - Full HTS (D-T)
...
1. **Current dossier**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/28-hts-tokamak-full-hts/dossier.md`
   (Does not exist yet — you will create it from scratch.)
   

2. **New research**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/28-hts-tokamak-full-hts/iter-01/output.md`
...
Write the complete dossier to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/28-hts-tokamak-full-hts/dossier.md` using the structure below. This OVERWRITES the previous dossier — include all information, not just changes.
...
Append the following to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/28-hts-tokamak-full-hts/changelog.md`:
...
- **Concept Name**: HTS Tokamak - Full HTS (D-T)
- **Company**: Energy Singularity
...
- **Lab Experiments**: EAST (ASIPP), HH70 (Energy Singularity)
