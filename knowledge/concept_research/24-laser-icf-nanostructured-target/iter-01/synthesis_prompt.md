# Dossier Synthesis: Laser ICF - Nanostructured Target (p-B11)
...
1. **Current dossier**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/23-laser-icf-nanostructured-target/dossier.md`
   (Does not exist yet — you will create it from scratch.)
   

2. **New research**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/23-laser-icf-nanostructured-target/iter-01/output.md`
...
Write the complete dossier to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/23-laser-icf-nanostructured-target/dossier.md` using the structure below. This OVERWRITES the previous dossier — include all information, not just changes.
...
Append the following to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/23-laser-icf-nanostructured-target/changelog.md`:
...
- **Concept Name**: Laser ICF - Nanostructured Target (p-B11)
- **Company**: Marvel Fusion, HB11 Energy
...
- **Lab Experiments**: LFEX (Osaka, p-B11 alpha detection), NIF ARC beamline experiments, ELI-NP (Romania), Vulcan (RAL UK)
