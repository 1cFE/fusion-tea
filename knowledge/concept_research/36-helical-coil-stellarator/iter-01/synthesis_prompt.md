# Dossier Synthesis: Helical Coil Stellarator (D-T)
...
1. **Current dossier**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/36-helical-coil-stellarator/dossier.md`
   (Does not exist yet — you will create it from scratch.)
   

2. **New research**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/36-helical-coil-stellarator/iter-01/output.md`
...
Write the complete dossier to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/36-helical-coil-stellarator/dossier.md` using the structure below. This OVERWRITES the previous dossier — include all information, not just changes.
...
Append the following to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/36-helical-coil-stellarator/changelog.md`:
...
- **Concept Name**: Helical Coil Stellarator (D-T)
- **Company**: Helical Fusion
...
- **Lab Experiments**: LHD (NIFS Japan)
