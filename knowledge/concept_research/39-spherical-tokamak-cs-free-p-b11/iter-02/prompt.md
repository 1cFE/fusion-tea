# Fusion Concept Research: Spherical Tokamak - CS-free p-B11
...
- **Name**: Spherical Tokamak - CS-free p-B11
- **Company**: ENN Energy
- **Confinement approach**: Magnetic Confinement
- **Description**: CS-free spherical tokamak with non-inductive ECRH current drive targeting p-B11. EXL-50U achieved 1 MA plasma current at 1.2 T (Jan 2024); EHL-2 next-gen device targeting 3 MA in 2027.
- **Known fuel**: p-B11 (Proton-Boron)
...
1. **Start broad**: Search the web for "ENN Energy fusion technology" and similar queries. Look for the company's website, Wikipedia page, Fusion Industry Association profile, press releases, and investor presentations.
...
ENN Energy's CS-free spherical tokamak concept eliminates the central solenoid in favor of non-inductive ECRH current drive, targeting p-B11 (proton-boron) aneutronic fusion. The EXL-50U device achieved 1 MA plasma current at 1.2 T in January 2024, and the next-generation EHL-2 device (low aspect ratio A ≈ 1.85, 3 T central field, R ≈ 1.05 m) is in design with 17 MW NBI + 6 MW ECRH heating, targeting p-11B thermal reaction rate verification and steady-state high-performance operation. EHL-2 is an experimental physics-verification machine, not a power-producing reactor.
...
- **Confidence**: low
- **Citation**: Inferred — p-B11 produces ~8.7 MeV in 3 alpha particles per reaction with <1% neutron yield; direct conversion is natural for aneutronic concepts. No published EHL-2 energy capture design.
- **Notes**: EHL-2 is an experimental device with no power conversion system. ENN has not published a plant-level design. Could alternatively be `TBD`.

### Magnet Type
- **Value**: `Resistive`
- **Confidence**: low
- **Citation**: Inferred from device class — EXL-50U at 1.2 T and EHL-2 at 3 T, at this scale, are consistent with copper TF/PF coils. No explicit superconducting statement found.
- **Notes**: HTS adoption (cf. ST40, Tokamak Energy) is plausible for follow-on devices but EHL-2 reads as a near-term experimental machine on conventional coils. Would benefit from a dedicated coil-engineering paper.
...
- **Magnet Type** (low confidence): Resolved by a coil-engineering paper or ENN technical report stating whether EHL-2 TF/PF coils are copper or HTS. The 3 T central field at R=1.05 m is consistent with either. Another iteration could help if a coil-system paper exists.
- **Energy Capture** (low confidence): ENN has not published a power-plant-level design; only the experimental EHL-2 is documented. A roadmap paper describing a post-EHL-2 reactor-class device would clarify direct conversion vs hybrid. Unlikely to be resolved without new ENN publications.
...
3. https://en.ennresearch.com/researchfield/Compactfusion/EHL_2/ — ENN Research EHL-2 page
4. https://en.ennresearch.com/researchfield/Compactfusion/device/ — ENN Xuanlong Experiment (EXL-50 / EXL-50U)
5. https://arxiv.org/abs/2104.14844 — Solenoid-free current drive via ECRH in EXL-50
6. https://iopscience.iop.org/article/10.1088/2058-6272/ad9e8f — EXL-50U strategy and experimental progress in support of EHL-2
7. https://conferences.iaea.org/event/392/papers/35644/files/13873-OV2999-EXL-50UOverview-YJShi.pdf — IAEA EXL-50U overview
8. https://pubs.aip.org/aip/pop/article/32/6/064701/3348211 — Comment on ENN's roadmap (critique)
9. Saved locally: `iter-01/sources/enn-roadmap-pb11-arxiv-2401.11338.md`
...
- **Magnet Type**: low confidence — needs better source
