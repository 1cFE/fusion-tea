# Dossier Synthesis: Spherical Tokamak - CS-free p-B11
...
1. **Current dossier**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/39-spherical-tokamak-cs-free-p-b11/dossier.md`
   (Does not exist yet — you will create it from scratch.)
   

2. **New research**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/39-spherical-tokamak-cs-free-p-b11/iter-01/output.md`
...
Write the complete dossier to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/39-spherical-tokamak-cs-free-p-b11/dossier.md` using the structure below. This OVERWRITES the previous dossier — include all information, not just changes.
...
Append the following to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/39-spherical-tokamak-cs-free-p-b11/changelog.md`:
...
- **Concept Name**: Spherical Tokamak - CS-free p-B11
- **Company**: ENN Energy
...
- **Fuel Type**: p-B11 (Proton-Boron)
- **Operation Mode**: Continuous
- **Published Machine/Plant?**: No
- **Lab Experiments**: EXL-50U (ENN), EHL-2 (planned)
