...
> (Workstream-1B, 2026-05-18).** This concept is **Focused Energy** —
> DPSSL (Nd:glass) compression + petawatt CPA *proton/ion fast ignition*,
> distinct from Xcimer's e-beam KrF excimer (now concept 27). The body below
> is inherited shared seed content; the autonomous research step must
> re-differentiate it to Focused Energy specifically. Treat shared/Xcimer
