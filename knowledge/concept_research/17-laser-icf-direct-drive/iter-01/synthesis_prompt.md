# Dossier Synthesis: Laser ICF - Direct Drive (D-T)
...
1. **Current dossier**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/17-laser-icf-direct-drive/dossier.md`
   (Does not exist yet — you will create it from scratch.)
   

2. **New research**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/17-laser-icf-direct-drive/iter-01/output.md`
...
Write the complete dossier to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/17-laser-icf-direct-drive/dossier.md` using the structure below. This OVERWRITES the previous dossier — include all information, not just changes.
...
Append the following to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/17-laser-icf-direct-drive/changelog.md`:
...
- **Concept Name**: Laser ICF - Direct Drive (D-T)
- **Company**: Xcimer Energy, Focused Energy
...
- **Lab Experiments**: NIF (LLNL, indirect drive achieved Q>1), OMEGA (U. Rochester, direct drive), LMJ (France), SG-III (China)
