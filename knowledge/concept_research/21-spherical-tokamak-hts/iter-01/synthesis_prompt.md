# Dossier Synthesis: Spherical Tokamak - HTS (D-T)
...
1. **Current dossier**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/21-spherical-tokamak-hts/dossier.md`
   (Does not exist yet — you will create it from scratch.)
   

2. **New research**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/21-spherical-tokamak-hts/iter-01/output.md`
...
Write the complete dossier to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/21-spherical-tokamak-hts/dossier.md` using the structure below. This OVERWRITES the previous dossier — include all information, not just changes.
...
Append the following to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/21-spherical-tokamak-hts/changelog.md`:
...
- **Concept Name**: Spherical Tokamak - HTS (D-T)
- **Company**: Tokamak Energy
...
- **Lab Experiments**: MAST-U (Culham/UKAEA), NSTX-U (PPPL), START (Culham), Globus-M2 (Ioffe Institute)
