# Fusion Concept Research: State-Backed Tokamak - BEST (D-T)
...
- **Name**: State-Backed Tokamak - BEST (D-T)
- **Company**: Neo Fusion
- **Confinement approach**: Magnetic Confinement
- **Description**: Developing BEST (Burning Plasma Experimental Superconducting Tokamak). Majority state-owned (CNPC, Chinese Academy of Sciences). Plans first plasma 2027, Q~5 by 2035. Part of China's national fusion strategy.
...
1. **Start broad**: Search the web for "Neo Fusion fusion technology" and similar queries. Look for the company's website, Wikipedia page, Fusion Industry Association profile, press releases, and investor presentations.
...
- **Confidence**: low
- **Citation**: Inferred — BEST is an experimental device, not a power plant
- **Notes**: BEST is not designed for electricity generation. No power conversion system. Value reflects the D-T thermal approach that would apply to a power-plant derivative, but this is extrapolation. Energy capture is structurally not a primary concern for this experimental device.
...
| Energy Capture | low confidence | BEST is experimental — no power conversion system. Value is extrapolated from D-T conventions. A future iteration focused on CFEDR/PFPP designs might clarify the intended power conversion for the reactor lineage. |
