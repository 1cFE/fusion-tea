# Dossier Synthesis: Dense Plasma Focus (p-B11)
...
1. **Current dossier**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/24-dense-plasma-focus/dossier.md`
   (Does not exist yet — you will create it from scratch.)
   

2. **New research**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/24-dense-plasma-focus/iter-01/output.md`
...
Write the complete dossier to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/24-dense-plasma-focus/dossier.md` using the structure below. This OVERWRITES the previous dossier — include all information, not just changes.
...
Append the following to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/24-dense-plasma-focus/changelog.md`:
...
- **Concept Name**: Dense Plasma Focus (p-B11)
- **Company**: LPPFusion
- **Confinement Approach**: Other
- **Description**: Pulsed coaxial electrodes create dense, short-lived plasma pinch (plasmoid). Claims path to p-B11 net energy via extreme ion temperatures in the pinch. Very simple, compact device. Direct energy conversion of charged fusion products.
- **Fuel Type**: p-B11 (Proton-Boron-11)
- **Operation Mode**: Pulsed
- **Published Machine/Plant?**: No
- **Lab Experiments**: Various DPF devices worldwide (Chile, Poland, Singapore), NX2 (Singapore), PF-1000 (IPPLM Warsaw)
