# Fusion Concept Research: Laser ICF - Liquid Jet Target (D-D)
...
- **Name**: Laser ICF - Liquid Jet Target (D-D)
...
1. **Start broad**: Search the web for "Cortex Fusion fusion technology" and similar queries. Look for the company's website, Wikipedia page, Fusion Industry Association profile, press releases, and investor presentations.
