# Dossier Synthesis: Magnetized Target Fusion - Pneumatic Compression (D-T)
...
1. **Current dossier**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/14-magnetized-target-fusion-pneumatic-compression/dossier.md`
   (Does not exist yet — you will create it from scratch.)
   

2. **New research**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/14-magnetized-target-fusion-pneumatic-compression/iter-01/output.md`
...
Write the complete dossier to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/14-magnetized-target-fusion-pneumatic-compression/dossier.md` using the structure below. This OVERWRITES the previous dossier — include all information, not just changes.
...
Append the following to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/14-magnetized-target-fusion-pneumatic-compression/changelog.md`:
...
- **Concept Name**: Magnetized Target Fusion - Pneumatic Compression (D-T)
- **Company**: General Fusion
