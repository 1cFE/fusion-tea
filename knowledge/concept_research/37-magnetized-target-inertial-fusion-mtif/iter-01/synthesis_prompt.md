# Dossier Synthesis: Magnetized Target Inertial Fusion - MTIF (D-D)
...
1. **Current dossier**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/37-magnetized-target-inertial-fusion-mtif/dossier.md`
   (Does not exist yet — you will create it from scratch.)
   

2. **New research**: `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/37-magnetized-target-inertial-fusion-mtif/iter-01/output.md`
...
Write the complete dossier to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/37-magnetized-target-inertial-fusion-mtif/dossier.md` using the structure below. This OVERWRITES the previous dossier — include all information, not just changes.
...
Append the following to `/home/reid/1cfe/fusion-tea/exploration/phase_1a/research/37-magnetized-target-inertial-fusion-mtif/changelog.md`:
...
- **Concept Name**: Magnetized Target Inertial Fusion - MTIF (D-D)
- **Company**: NearStar Fusion
