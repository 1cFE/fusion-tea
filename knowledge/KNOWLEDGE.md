...
- **Amendment 2026-08-28** `[OWNER 2026-08-28]` (goal `p-pump-basis` round 1; ruling recorded in `work/orchestration/goals/p-pump-basis/trail.md` § Goal close): the stated 2 % floor is a **divertor-relative figure read as plant-relative** — `osti-servlets-purl-1178069.md:100` reads "~1% of the total thermal power (~2% to 3% of thermal power in the He-cooled divertor)", so ARIES-ACT's plant-level figure is ~1 % and the ~60 MW end of the Stellaris band has no figure behind it (this settles the 60–190 vs 30–190 discrepancy in the research file's favour: 1 % of ~3150 MWth ≈ 31 MW). The **helium-primary-blanket subset is ~4–6 %** (Cismondi ~6.3 % at `:174,176`; Moscato ≈6.2 % and near-term ~4 %, second-order grade); against the model's computed `p_th` at the baseline geometry the same fractions give **~130–195 MW**. The 2–6 % basis is deliberately **not narrowed**: ARIES-ACT's ~1 % is a real plant-level figure for a machine carrying about half its blanket heat in helium, and it is the strongest evidence against the upper figures. Re-basing is routed to WI-033. The Cismondi warrant line is `:174` (HCPB-representative-for-HCLL), not `:176`.
- **Status**: captured
