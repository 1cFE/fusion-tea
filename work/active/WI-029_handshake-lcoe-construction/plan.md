...
- **Traps.** All eleven pass (five pre-existing WI-028 + six new WI-029; tally corrected 12→11 per audit F3 — no trap missing, the inherited count was misstated), each printed with its detail line:
