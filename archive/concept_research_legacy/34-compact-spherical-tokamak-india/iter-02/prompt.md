# Fusion Concept Research: Compact Spherical Tokamak - India (D-T)
...
- **Name**: Compact Spherical Tokamak - India (D-T)
- **Company**: Pranos Fusion
- **Confinement approach**: Magnetic Confinement
- **Description**: Developing modular compact spherical tokamaks for distributed clean energy. Early-stage Indian startup supported by Atal Innovation Mission. Based in Bengaluru.
...
1. **Start broad**: Search the web for "Pranos Fusion fusion technology" and similar queries. Look for the company's website, Wikipedia page, Fusion Industry Association profile, press releases, and investor presentations.
...
Pranos Fusion is an extremely early-stage Indian startup (founded May 2024, ~$417K seed funding) developing modular compact spherical tokamaks for distributed clean energy. Based in Bengaluru and supported by Atal Innovation Mission, the company envisions deploying 2,500 x 50 MW modular reactors. The founders are pre-concept-design stage, working with plasma in a glass globe at JNCASR Bengaluru. Co-founder Shaurya Kaushal has a PhD in computational physics and prior experience at UKAEA. The company may also be investigating stellarator concepts.
...
- **Value**: MFE
- **Confidence**: high
- **Citation**: Baseline CSV; confirmed by research iter-01
- **Notes**: Magnetic confinement via spherical tokamak geometry.

### Confinement Concept
- **Value**: Spherical tokamak
- **Confidence**: medium
- **Citation**: iter-01/sources/pranos-fusion-overview.md
- **Notes**: Fusion Energy Base notes they're also investigating stellarator concepts. Primary concept appears to be spherical tokamak.

### Fuel
- **Value**: D-T
- **Confidence**: low
- **Citation**: Baseline CSV
- **Notes**: Listed as D-T in the initial concept CSV but not directly confirmed by the company in any public source found so far.

### Primary Heating
- **Value**: TBD
- **Confidence**: low
- **Citation**: No public information found
- **Notes**: No heating method disclosed. Typical spherical tokamak heating includes NBI and/or RF, but no basis to assign a value.

### Energy Capture
- **Value**: TBD
- **Confidence**: low
- **Citation**: No public information found
- **Notes**: No energy conversion approach disclosed. If D-T is confirmed, `Thermal (unspecified)` would be a reasonable default, but the company has not specified.

### Plasma State
- **Value**: Burning
- **Confidence**: low
- **Citation**: Inferred from D-T steady-state tokamak design intent
- **Notes**: A 50 MW power-producing D-T tokamak would target burning plasma, but at this stage the company has not described plasma parameters. Could also be `Sustained` depending on target Q.

### Magnet Type
- **Value**: Unknown
- **Confidence**: low
- **Citation**: No public information found
- **Notes**: No magnet technology disclosed. Modern compact spherical tokamak designs (e.g., Tokamak Energy) typically use HTS, but no basis to assign a value for Pranos.

### Tritium Breeding
- **Value**: TBD
- **Confidence**: low
- **Citation**: No public information found
- **Notes**: If D-T fuel is confirmed, tritium breeding blanket is required. No blanket type disclosed.

### Neutron Management
- **Value**: Heavy shielding (14 MeV)
- **Confidence**: medium
- **Citation**: Inferred from D-T fuel assumption (iter-01)
- **Notes**: Follows directly from D-T fuel cycle producing 14.1 MeV neutrons. If an integrated blanket/shield approach is adopted, this could change to `Integrated blanket/shield`.

### Operation Mode
- **Value**: Steady-state
- **Confidence**: medium
- **Citation**: Baseline CSV ("Continuous"); confirmed by research iter-01
...
- **Confidence**: low
- **Citation**: No public information found
- **Notes**: No distinguishing driver technology disclosed. The company is pre-concept-design stage.

## Remaining Gaps

| Column | Status | Search Coverage | Likely Resolvable? |
|--------|--------|----------------|-------------------|
| Fuel | Low confidence (unconfirmed D-T) | Web search, Fusion Energy Base, company LinkedIn | Unlikely without company disclosure |
| Primary Heating | TBD | Web search, company profiles | Unlikely -- too early-stage |
| Energy Capture | TBD | Web search | Unlikely -- too early-stage |
| Plasma State | Low confidence inference | Web search | Unlikely without design publication |
| Magnet Type | Unknown | Web search, company profiles | Unlikely -- too early-stage |
| Tritium Breeding | TBD | Web search | Unlikely -- too early-stage |
| Driver Technology | Unknown | Web search, company profiles | Unlikely -- too early-stage |

Most gaps are structural: Pranos Fusion is pre-concept-design and has not published technical specifications. Another research iteration is unlikely to yield significant new information unless the company publishes new materials.

## Key Sources

1. **iter-01/sources/pranos-fusion-overview.md** — Compiled overview of Pranos Fusion from web research
2. **Baseline CSV** — Initial concept listing with company name, fuel type, and operation mode
3. **India IPR context** — SST-1 and Aditya-U tokamaks at IPR Gandhinagar; SS-ST spherical tokamak commissioned Dec 2025
...
- **Fuel**: low confidence — needs better source
- **Primary Heating**: currently TBD
- **Energy Capture**: currently TBD
- **Plasma State**: low confidence — needs better source
- **Magnet Type**: currently Unknown
- **Tritium Breeding**: currently TBD
- **Driver Technology**: currently Unknown
