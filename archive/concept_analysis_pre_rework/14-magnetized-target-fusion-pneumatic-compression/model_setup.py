...
AVAILABILITY = 0.75
# Canonical value per scoring_framework.md §"Plant availability" (Pulsed MIF, D-T).
# Previously 0.8 (midpoint of 75–90% analogue band); overridden by project-wide
# policy — no Tier-A published availability target exists for this concept.
# Cross-concept LCOE comparisons are now apples-to-apples on this dimension.
# Actual maintenance schedule for the pneumatic compression system remains
# completely unknown; availability sensitivity sweeps below test the range.
