# 1costingfe Model Setup: QI Modular HTS Stellarator - Infinity Two

You are generating a runnable 1costingfe model setup script for **QI Modular HTS Stellarator - Infinity Two**
(Type One Energy).
...
## Output
Write the script to: `/home/reid/1cfe/fusion-tea/exploration/concept_analysis/analyses/20a-type-one-stellarator/iter-1/model_setup.py`
