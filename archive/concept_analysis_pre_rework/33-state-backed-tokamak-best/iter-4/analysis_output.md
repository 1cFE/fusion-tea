...
A published integrated modeling study (Deng et al. 2019, arxiv-1907-11919) provides important constraints on the extrapolation chain. CFETR Phase II uses the same hardware as Phase I (R₀ = 6.6 m, B₀ = 6.0 T) and achieves Pfus = 1084 MW, Qfus = 23.5, fbs = 89% by increasing plasma current to 11 MA — "theoretically validating the feasibility of DEMO operation" [arxiv-1907-11919.md §Summary]. This is the key bridge between BEST's experimental program and the commercial PFPP. However, Phase II readiness gaps are substantial and must be carried as risks in the LCOE model: (a) the divertor heat load (Pdiv/R₀ = 32.4 MW/m) exceeds ITER design guidelines and requires radiative impurity mantle mitigation not yet validated in integrated modeling; (b) pellet injection fueling is necessary to sustain Phase II densities but has not been implemented in the simulation workflow; and (c) RWM (resistive wall mode) stabilization at βN = 3.54 — above the no-wall stability limit — requires flow, kinetic, and feedback stabilization physics that were explicitly excluded from the analysis and flagged for future work [arxiv-1907-11919.md §Section 4.4]. These gaps confirm that even the physics-validation pathway to DEMO-class operation from CFETR remains incomplete.
...
- **H1**: If the Chinese 2× construction cost discount holds for fusion, PFPP LCOE drops from ~150 $/MWh to ~80 $/MWh (capital cost halved at ~70% capital share of LCOE). For H1 to produce this magnitude of LCOE reduction, the discount must apply broadly across all construction-labor-intensive capital accounts (CAS21 buildings, CAS22 reactor plant equipment, CAS23–CAS26 supporting systems) — not just the buildings sub-account (~8% of capital). CAS22 reactor plant equipment (~44% of overnight capital, dominated by magnets, vacuum vessel, blanket, H&CD systems) is precisely where Chinese domestic supply chains, lower labor rates, and streamlined regulatory costs would differentiate most strongly from Western estimates.
...
- **H3**: If PFPP inherits CFETR's pulsed regime (duty cycle 0.3–0.5) rather than quasi-steady-state operation, LCOE increases 1.5–3× relative to the quasi-steady-state 85% CF central case (canonical per scoring_framework.md §Plant availability, MCF quasi-steady D-T). Cross-concept LCOE comparisons within the MCF family use this same 0.85 baseline, making pulsed-vs-QSS comparisons apples-to-apples on the availability dimension.
...
**CFETR Phase I Parameters (Intermediate Step — Preferred 2019 Configuration)**

*Note: An earlier design used R₀ = 5.7 m, B₀ = 5 T, Ip = 10 MA, Pfus = 200 MW [osti-pages-servlets-purl-1465662.md §Section 2.2]. The 2019 integrated modeling study (Deng et al., arxiv-1907-11919) validated a larger preferred configuration with better performance at the same auxiliary power; parameters below reflect this updated design.*

| Parameter | Value/Range | Source | Confidence | Notes |
|-----------|-------------|--------|------------|-------|
| Major radius (CFETR Phase I) | 6.6 m | arxiv-1907-11919.md §Section 2 | medium | Preferred configuration; earlier R₀ = 5.7 m iteration superseded |
| Minor radius (CFETR Phase I) | 1.8 m | arxiv-1907-11919.md §Section 2 | medium | Aspect ratio A = 3.67 |
| Toroidal field (CFETR Phase I) | 6.0 T | arxiv-1907-11919.md §Section 2 | medium | On-axis; same field as Phase II |
| Plasma current (CFETR Phase I) | 7.6 MA | arxiv-1907-11919.md §Table 1 | medium | Baseline scenario (lower than earlier 10 MA design iteration) |
| Fusion power (CFETR Phase I) | 171 MW | arxiv-1907-11919.md §Table 1 | medium | Phase I baseline scenario simulation result |
| Q value (CFETR Phase I) | 3.2 | arxiv-1907-11919.md §Table 1 | medium | NB+EC heating; Paux = 54 MW (33.6 MW NBI + 20 MW ECH) |
| H98y2 confinement factor | 1.31 | arxiv-1907-11919.md §Table 1 | medium | Above ITER baseline (H98=1.0); modest enhancement required |
| Bootstrap current fraction | 64% | arxiv-1907-11919.md §Table 1 | medium | Ibs = 4.85 MA; significant non-inductive drive |
| Neutron wall loading (CFETR Phase I) | 0.19 MW/m² | arxiv-1907-11919.md §Section 4.2 | medium | Phase I NWL; Phase II is ~6× higher |
| Duty cycle (CFETR Phase I) | 0.3–0.5 | osti-pages-servlets-purl-1465662.md §Introduction | medium | Pulsed/quasi-steady operation; key constraint for PFPP CF assumption |
| Q sensitivity — NBI impact (earlier design) | Q=2.0 (NB+EC) vs. Q=1.2 (EC+LH, no NBI) | osti-pages-servlets-purl-1465662.md §Section 3.2 | medium | From earlier R₀=5.7m design; quantifies NBI removal penalty (~40% Q degradation) — principle persists in updated design |

**CFETR Phase II Parameters (Same Machine — DEMO-Validation Scenario)**

*Phase I and Phase II use the same hardware (R₀ = 6.6 m, B₀ = 6.0 T). Phase II accesses higher performance by increasing plasma current to 11 MA through a four-step incremental sequence. Phase II "theoretically validates the feasibility of DEMO operation" [arxiv-1907-11919.md §Summary].*

| Parameter | Value/Range | Source | Confidence | Notes |
|-----------|-------------|--------|------------|-------|
| Machine geometry (Phase II) | R₀ = 6.6 m, B₀ = 6.0 T | arxiv-1907-11919.md §Section 4.2 | medium | Identical to Phase I hardware; no device upgrade required |
| Plasma current (CFETR Phase II) | 11 MA | arxiv-1907-11919.md §Table 3 | medium | Increased from 7.6 MA (Phase I) through four-step ramp |
| Fusion power (CFETR Phase II) | 1084 MW | arxiv-1907-11919.md §Table 3 | medium | Alpha-dominated regime; Pfus/Phase I ≈ 6.3× |
| Q value (CFETR Phase II) | 23.5 | arxiv-1907-11919.md §Table 3 | medium | High gain; Paux = 46 MW (26 MW NBI + 20 MW ECH) |
| Bootstrap current fraction | 89% | arxiv-1907-11919.md §Table 3 | medium | Ibs = 9.76 MA; near-fully non-inductive |
| Normalized beta (βN) | 3.54 | arxiv-1907-11919.md §Section 4.4 | medium | Above no-wall limit (1.24); requires RWM stabilization not yet modeled |
| Neutron wall loading (Phase II) | ~1.1 MW/m² | [inferred: ~6× Phase I NWL of 0.19 MW/m²; consistent with Pfus ratio 6.3×] | low | Approaches commercial-class NWL; Phase II divertor Pdiv/R₀ = 32.4 MW/m |
| Divertor heat load | Pdiv/R₀ = 32.4 MW/m | arxiv-1907-11919.md §Section 4.5 | medium | Exceeds ITER design guideline; requires radiative mantle mitigation |
| Auxiliary heating (Phase II) | 46 MW (26 MW NBI + 20 MW ECH) | arxiv-1907-11919.md §Section 4.2 | medium | NBI cannot be eliminated; pellet injection also required for density |
...
| Overnight capital cost (PFPP) | [estimated] $5–15B | [analogue: ARIES-ACT1 at R₀=6.25 m, B₀=6.0 T (osti-servlets-purl-1178069); Chinese construction discount 2–4× applied broadly to CAS21–CAS26] | low | ARIES-ACT1 geometry matches CFETR better than ARIES-AT; COE ~64 mills/kWh at 1000 MWe without Chinese discount |
...
| Availability / capacity factor — central case (quasi-steady-state PFPP) | 0.85 | scoring_framework.md §Plant availability (MCF quasi-steady, D-T); previously estimated 75–90% Araiinejad & Shirvan range | low | Canonical per project-wide policy; no Tier-A concept-specific override (no published PFPP availability target). Sensitivity sweep covers 0.35–0.90 (CF=35%: 335 $/MWh → CF=90%: 143 $/MWh per model_output.txt). |
...
|-----------|----------|-------------|-------|
| Commercial PFPP design point (R, B, Q, P_fusion) | not-yet-sourced | blocking | CFETR Phase I (R₀=6.6 m, B₀=6.0 T) and Phase II (Pfus=1084 MW, Q=23.5) are published (see Available Parameters); commercial PFPP (Phase III/DEMO-class) not yet specified — must be assumed by analogy to ARIES-ACT1 / EU-DEMO |
...
|---|-----------------|---------|----------|-------------|----------------------|
| 1 | Commercial PFPP design point (Phase II / DEMO-class) unspecified; CFETR Phase I preferred configuration is published (R₀ = 6.6 m, B₀ = 6.0 T, Ip = 7.6 MA, Pfus = 171 MW, Qfus = 3.2, duty cycle 0.3–0.5); CFETR Phase II DEMO-validation scenario published (Pfus = 1084 MW, Qfus = 23.5) but with outstanding readiness gaps | S1, S2, S5 | not-yet-sourced (PFPP) | blocking | CFETR Phase I preferred geometry from arxiv-1907-11919; CFETR Phase II from same source; commercial PFPP remains unanchored — use CFETR Phase I + ARIES-ACT1 (R₀=6.25 m) as primary Western cost analog; ARIES-ACT2 (R₀=9.75 m) as upper bound |
...
While 21-spherical-tokamak-hts is the only approved analysis available for cross-reference, BEST's structurally closest neighbors by geometry and magnet technology are **01-hts-compact-tokamak** (CFS SPARC-class, A ≈ 3, full-HTS REBCO at 20 T, R₀ ≈ 1.85 m) and **28-hts-tokamak-full-hts** (Energy Singularity, compact conventional AR, full-HTS at 25 T). Both are in-progress analyses. The central TEA question differentiating BEST from these concepts is whether lower conductor cost per unit length (Nb3Sn $2–10/kA-m vs. REBCO $30–100/kA-m) combined with Chinese construction economics (2–4× discount) offsets the larger machine volume required at lower field.

A rough parametric bound (order-of-magnitude, ±factor-of-2 uncertainty): A commercial PFPP at R₀ = 6.6 m, B₀ = 6.0 T (CFETR Phase I geometry) has a plasma volume ~(6.6/1.85)³ ≈ 46× larger than SPARC, requiring magnet mass scaling with roughly R₀^2.5 → (6.6/3.6)^2.5 ≈ 5× BEST's ~2,000 t → ~10,000 t for PFPP. With Nb3Sn strand at ~20% of total mass and $200/kg fabricated conductor cost, total Nb3Sn strand cost is approximately $400M, but complete winding and structure multiplies this by 3–5× → **$1.2–2B LTS magnet system** at 1000 MWe. For a compact HTS plant (CFS ARC-class, R₀ ≈ 3.3 m, 20 T), published estimates imply ~5,000–8,000 km of REBCO tape. At 2025 market price (~$50/m), tape alone is $250–400M, plus winding and structure → **$0.75–1.6B HTS magnet system** at current tape prices, or **$150–500M at the $10/m cost target**. This suggests that at 2025 REBCO prices, LTS and HTS magnet system costs are within a factor of ~2 for comparable net electrical output. The compact HTS path wins if REBCO hits its $10–15/m price target; the LTS path benefits from greater blanket area and tritium breeding volume at larger machine scale. The Chinese construction discount (H1) potentially reduces PFPP capital cost substantially, but this discount applies to both magnet paths — it does not eliminate the LTS vs. HTS trade-off. Formal resolution requires parametric cost comparison once 01-hts-compact-tokamak and 28-hts-tokamak-full-hts analyses are approved.

**Cross-concept positioning for TEA pipeline:**

BEST occupies the "state-backed experimental device with commercial lineage" niche that has no clear equivalent in the private-sector-dominated Western fusion landscape. The closest Western analog is the ITER → EU-DEMO pathway. BEST should be modeled in the TEA pipeline as a parameterized conventional-aspect-ratio D-T tokamak anchored to CFETR Phase I parameters (R₀ = 6.6 m, B₀ = 6.0 T, Ip = 7.6 MA, Pfus = 171 MW, Qfus = 3.2; Deng et al. 2019) for the intermediate step and extrapolating to a commercial PFPP at 500 MW–1.2 GW net electric — the economic sweet spot established by the UKAEA PROCESS extrapolation study [scientific-publications-wp-content-uploads-extrapolating.md §Conclusion: "the sweet spot for a commercial scale fusion power plant is between 500 MW and 1.2 GW net electric output"]. The gross-to-net ratio degradation at smaller plant sizes (17% at 100 MWe vs. 42% at 1.2 GWe) makes a first-of-kind PFPP at 500 MWe marginally viable but sensitive to recirculating power assumptions.

Key modeling parameters:
- LTS Nb3Sn as primary magnet technology; CFETR geometry R₀ = 6.6 m, B₀ = 6.0 T (Deng et al. 2019, arxiv-1907-11919) as intermediate design anchor
- Western cost analog: **ARIES-ACT1** (R₀ = 6.25 m, B₀ = 6.0 T, 1000 MWe, COE ~64 mills/kWh; osti-servlets-purl-1178069) preferred over ARIES-AT (R₀ = 5.2 m) due to geometric match with CFETR; ARIES-ACT2 (R₀ = 9.75 m, B₀ = 8.75 T) provides conservative upper bound
- sCO2 Brayton power conversion at 34.7% efficiency (central case)
- Chinese construction cost discount as scenario parameter [1×, 2×, 4×] — **must apply to CAS21–CAS26 direct capital accounts** (not just buildings) to test H1; CAS22 reactor plant equipment (~44% of overnight capital) is the primary differentiated account
- Blanket technology as sensitivity branch: COOL/sCO2 (34.7%) vs. WCCB/Rankine (26.4%)
- Availability / capacity factor: 0.85 central case (canonical per scoring_framework.md §Plant availability, MCF quasi-steady D-T); pulsed downside scenario 30–50% (CFETR Phase I duty cycle); sensitivity sweep 0.35–0.90 in model
- Q as sensitivity sweep: Q = 5 to 15, revealing the cliff-edge in net electrical output as recirculating H&CD power approaches gross generation at low Q
...
**8. CFETR Phase I Physics Simulation (OSTI 1465662) — Earlier Design Iteration**
- Contribution: Establishes an earlier CFETR Phase I design point (R₀ = 5.7 m, a = 1.6 m, B₀ = 5 T, Ip = 10 MA, 200 MW fusion power, duty cycle 0.3–0.5) — superseded by the preferred 2019 configuration (R₀ = 6.6 m) documented in Source 11 for geometry-sensitive parameters. Still provides the primary quantification of NBI impact on Q: NB+EC achieves Q ≈ 2.0; EC+LH only (no NBI) achieves Q ≈ 1.2, confirming NBI removal degrades Q by ~40% through loss of plasma rotation and direct ion heating. Also documents the duty cycle 0.3–0.5 pulsed operation target. Used for LHCD applicability characterization and duty-cycle scenario framing.
...
**10. ARIES-ACT Study (Kessel et al.) — ARIES-ACT1 and ARIES-ACT2 Tokamak Cost Studies**
- Full citation: Kessel, C.E. et al. (2015 era) "The ARIES Advanced and Conservative Tokamak (ARIES-ACT) Power Plant Study," *Fusion Science and Technology*, ARIES team.
- Contribution: Four-corners study of commercial tokamak parameter space. **ARIES-ACT1** (R₀ = 6.25 m, B₀ = 6.0 T, 1000 MWe, COE ~64 mills/kWh, 58% thermal efficiency via SiC/SCLL blanket, Qfus = 42.7) is the closest Western cost analog for the CFETR PFPP (R₀ = 6.6 m, B₀ = 6.0 T). ARIES-ACT2 (R₀ = 9.75 m, B₀ = 8.75 T, Qfus ~25, 45% thermal efficiency) provides a conservative large-machine upper bound. ARIES-ACT1 geometry match (vs. ARIES-AT at R₀ = 5.2 m) reduces systematic error in capital cost scaling driven by machine size (magnet conductor length, vacuum vessel area, structural steel — all scale non-linearly with R₀).
- Location: `iter-02/sources/osti-servlets-purl-1178069.md`

**11. Deng, B.Q. et al. (2019) — CFETR Phase I and Phase II Integrated Modeling**
- Full citation: Deng, B.Q. et al. (2019) "Integrated modeling of CFETR steady-state scenario with normalized β = 1.88 and Q = 3.2 for phase I and high-performance scenario for phase II," arXiv:1907.11919.
- Contribution: Validates the preferred CFETR Phase I configuration (R₀ = 6.6 m, B₀ = 6.0 T, Ip = 7.6 MA, Pfus = 171 MW, Qfus = 3.2, H98 = 1.31, NWL = 0.19 MW/m²), superseding the earlier R₀ = 5.7 m design. Establishes CFETR Phase II as a DEMO-validation scenario achievable in the same hardware: Pfus = 1084 MW, Qfus = 23.5, fbs = 89%, Ip = 11 MA. Documents outstanding Phase II readiness gaps: divertor heat load (Pdiv/R₀ = 32.4 MW/m) exceeding ITER limits, pellet injection fueling not yet implemented, RWM stabilization at βN = 3.54 (above no-wall limit) not yet modeled.
- Location: `iter-02/sources/arxiv-1907-11919.md`

**12. ARIES Team (various dates, late 1990s–early 2000s) — ARIES-AT Tokamak Study**
- Contribution: Published plant-level CAS cost breakdowns for a conventional-aspect-ratio D-T tokamak (ARIES-AT: R₀ = 5.2 m, B₀ = 5.9 T, Q ≈ 5). Less geometrically matched to CFETR than ARIES-ACT1 (see Source 10), but provides the most widely-cited conventional tokamak cost structure in the ARIES series. Still useful for cross-checking cost account fractions.
