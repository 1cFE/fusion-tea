...
| Net electrical output (commercial PFPP) | [estimated] 500–1000 MWe | [analogue: CFETR, DEMO-class devices; Chinese program targets 1 GW class] | low | No published PFPP design point |
...
| Capacity factor (PFPP) | [analogue] 75–90% | [analogue: Araiinejad & Shirvan (2025) D-T MCF range; 21-spherical-tokamak-hts analysis §S5] | low | No Chinese program estimate; quasi-steady operation likely similar to conventional D-T tokamak range |
...
|-----------|----------|-------------|-------|
| CFEDR/PFPP commercial design point (R, B, Q, P_fusion) | truly-unknown | blocking | No published commercial reactor engineering specification; must be assumed by analogy |
...
|---|-----------------|---------|----------|-------------|----------------------|
| 1 | CFEDR/PFPP commercial design point (machine parameters, Q, fusion power) completely unspecified | S1, S2, S5 | truly-unknown | blocking | Monitor ASIPP and Chinese fusion program publications; use ARIES-AT or EU-DEMO as analogue; PROCESS code parametric scan can bound the design space |
...
| 7 | LHCD applicability in burning plasma scenarios | S2, S3, S5 | derivable | important | Lower-hybrid wave cutoff density and temperature limits are well-characterized in literature; apply to BEST burning plasma parameters to determine effective LHCD contribution at Q~5 |
...
BEST occupies the "state-backed experimental device with commercial lineage" niche that has no clear equivalent in the private-sector-dominated Western fusion landscape. The closest Western analog is the ITER → EU-DEMO pathway. BEST should be modeled in the TEA pipeline as a parameterized conventional-aspect-ratio D-T tokamak (R₀ ≈ 5–8 m, B₀ ≈ 6–8 T, A ≈ 3–4, Q ≈ 5–15) with:
- LTS Nb3Sn as primary magnet technology
- sCO2 Brayton power conversion at 34.7% efficiency
- Chinese construction cost discount applied to ARIES/PROCESS baseline
- Blanket technology as a sensitivity parameter (COOL/WCCB/WCLL bracket)
- Regulatory cost as a scenario branch (Chinese vs. Western framework)
...
**8. ARIES Team (various dates, late 1990s–early 2000s) — ARIES-AT, ARIES-ST Tokamak Studies**
