...
You are performing a data gap assessment for the fusion concept **Projectile ICF (D-T)** (First Light Fusion) as preparation for a comprehensive qualitative and quantitative concept analysis.
...
- **Dossier**: `/home/reid/1cfe/fusion-tea/knowledge/concept_research/22-projectile-icf/dossier.md`
...
1. **Skim the index below first** to identify which fleet-wide sources are plausibly applicable to **Projectile ICF (D-T)** (match on confinement family, fuel cycle, plant type, or cost-modeling scope).
