...
You are performing a data gap assessment for the fusion concept **Laser ICF - Nanostructured Target (p-B11)** (Marvel Fusion) as preparation for a comprehensive qualitative and quantitative concept analysis.
...
- **Dossier**: `/home/reid/1cfe/fusion-tea/knowledge/concept_research/23-laser-icf-nanostructured-target/dossier.md`
...
1. **Skim the index below first** to identify which fleet-wide sources are plausibly applicable to **Laser ICF - Nanostructured Target (p-B11)** (match on confinement family, fuel cycle, plant type, or cost-modeling scope).
