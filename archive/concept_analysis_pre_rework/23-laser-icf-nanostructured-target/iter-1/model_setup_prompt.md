# 1costingfe Model Setup: Laser ICF - Nanostructured Target (p-B11)

You are generating a runnable 1costingfe model setup script for **Laser ICF - Nanostructured Target (p-B11)**
(Marvel Fusion).
...
`/home/reid/1cfe/1costingfe/src/costingfe/data/defaults/ife_laser_ife.yaml`
...
## Output
Write the script to: `/home/reid/1cfe/fusion-tea/exploration/concept_analysis/analyses/23-laser-icf-nanostructured-target/iter-1/model_setup.py`
