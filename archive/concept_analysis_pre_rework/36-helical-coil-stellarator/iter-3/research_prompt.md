# Research Agent: Autonomous Source Acquisition for Helical Coil Stellarator
...
### G-6: sCO2 power cycle efficiency at fusion-coupled plant scale — only kW-scale at 20% demonstrated; target is >50%; intermediate-scale test results absent [PARTIAL]
- Iteration 2: searched "sCO2 supercritical CO2 Brayton cycle 50% efficiency 1200K high temperature power conversion fusion", "NIFS Oroshhi-2 sCO2 Brayton cycle fusion power conversion Ishiyama Tanaka stellarator", "sCO2 supercritical CO2 Brayton cycle fusion reactor power conversion efficiency >50% stellarator arxiv site:arxiv.org"
  - Extracted: arxiv-1401-4232 (https://arxiv.org/pdf/1401.4232)
  - Failed: https://www.sciencedirect.com/science/article/pii/S0920379621006360 — Extraction failed — JavaScript-rendered page, trafilatura returned no content (rc=1)
  - Failed: https://www.mdpi.com/1996-1073/16/21/7367 — HTTP 403 Forbidden — MDPI blocking automated access

### G-7: Liquid metal alloy composition (at.% fractions of Sn, In, Pb, Li) not publicly confirmed; affects indium supply risk, tritium chemistry, structural material corrosion [FAILED]
- Iteration 2: searched "Miyazawa Goto HESTIA helical stellarator liquid metal alloy composition tin indium lithium blanket"

### G-11: Component replacement intervals (LM blanket modules, HTS coils) not stated — affects availability and maintenance OPEX [SKIPPED]
- Iteration 2: searched (no queries)

### G-16: Independent stellarator FPP cost study for heliotron geometry — no heliotron-specific analogue exists; ARIES-CS provides modular stellarator baseline [PARTIAL]
- Iteration 2: searched "ARIES-CS compact stellarator power plant study cost 2008 site:osti.gov OR site:arxiv.org"
  - Failed: https://aries.pppl.gov/LIB/REPORT/JOURNAL/FST/08-FST-Najmabadi.pdf — HTTP 401 Unauthorized — PPPL server requires institutional authentication
...
```
uv run python scripts/run_analysis.py add-source 36 "<url>"
```
...
`/home/reid/1cfe/fusion-tea/exploration/concept_analysis/analyses/36-helical-coil-stellarator/iter-3/research_output.json`
