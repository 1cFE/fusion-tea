...
You are performing a data gap assessment for the fusion concept **Helical Coil Stellarator (D-T)** (Helical Fusion) as preparation for a comprehensive qualitative and quantitative concept analysis.
...
- **Dossier**: `/home/reid/1cfe/fusion-tea/knowledge/concept_research/36-helical-coil-stellarator/dossier.md`
...
1. **Skim the index below first** to identify which fleet-wide sources are plausibly applicable to **Helical Coil Stellarator (D-T)** (match on confinement family, fuel cycle, plant type, or cost-modeling scope).
