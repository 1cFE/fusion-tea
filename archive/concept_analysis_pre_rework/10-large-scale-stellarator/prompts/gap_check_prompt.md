...
You are performing a data gap assessment for the fusion concept **Large-Scale Stellarator (D-T)** (Gauss Fusion) as preparation for a comprehensive qualitative and quantitative concept analysis.
...
- **Dossier**: `/home/reid/1cfe/fusion-tea/knowledge/concept_research/10-large-scale-stellarator/dossier.md`
...
1. **Skim the index below first** to identify which fleet-wide sources are plausibly applicable to **Large-Scale Stellarator (D-T)** (match on confinement family, fuel cycle, plant type, or cost-modeling scope).
