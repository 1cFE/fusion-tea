# 1costingfe Model Setup: Laser ICF - Indirect Drive (D-T)

You are generating a runnable 1costingfe model setup script for **Laser ICF - Indirect Drive (D-T)**
(Inertia Enterprises).
...
## Output
Write the script to: `/home/reid/1cfe/fusion-tea/exploration/concept_analysis/analyses/26-laser-icf-indirect-drive/iter-1/model_setup.py`
