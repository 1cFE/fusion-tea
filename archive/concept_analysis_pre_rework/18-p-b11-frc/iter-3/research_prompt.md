# Research Agent: Autonomous Source Acquisition for p-B11 FRC
...
### G-13: Plant capacity factor target — steady-state concept avoids pulsed penalties but FRC CW operation undemonstrated [PARTIAL]
- Iteration 2: searched "TAE Technologies Da Vinci capacity factor availability operational uptime fusion plant", "beam-driven FRC steady-state fusion plant capacity factor availability factor site:arxiv.org OR site:osti.gov"
  - Extracted: arxiv-2103-12451 (https://arxiv.org/abs/2103.12451)

### G-15: B-11 isotopic enrichment cost if higher purity required than natural abundance [FAILED]
- Iteration 2: searched "boron-11 isotope enrichment cost price per kg commercial supplier", "boron-11 enrichment cost fusion fuel p-B11 aneutronic site:arxiv.org OR site:osti.gov"
  - Failed: https://www.researchgate.net/figure/Market-Price-of-Boron-Isotope-Product-Abundance-Price_tbl1_347386544 — 403 Forbidden — institutional login required
  - Failed: https://www.osti.gov/servlets/purl/4364833 — PDF binary not readable by WebFetch; content could not be assessed for relevance
...
```
uv run python scripts/run_analysis.py add-source 18 "<url>"
```
...
`/home/reid/1cfe/fusion-tea/exploration/concept_analysis/analyses/18-p-b11-frc/iter-3/research_output.json`
