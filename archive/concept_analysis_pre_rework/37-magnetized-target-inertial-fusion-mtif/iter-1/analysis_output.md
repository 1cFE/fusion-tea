...
Plasma-armature railguns operating at Mach 30 (10 km/s) subject the rail surfaces to extreme electromagnetic erosion, thermal ablation, and mechanical stress. At 1 Hz over a plant lifetime, the railgun fires approximately 28 million shots per year, or roughly 840 million shots over 30 years. Rail lifetimes in defense hypervelocity research programs are typically measured in hundreds to a few thousand shots at these velocities — not millions. The gap between demonstrated rail life and plant-scale requirement is approximately six orders of magnitude. Rail replacement frequency and cost would likely dominate operating costs and strongly affect capacity factor. No data exists from NearStar on expected rail life, replacement schedule, or replacement cost.
...
**O&M Considerations**: No O&M cost breakdown is disclosed. For an analogue, MIF pulsed concepts (MagLIF concept 07, General Fusion concept 14) have flagged periodic replacement of consumables (RTL, liner/target) as a dominant operating cost. For NearStar, the closest equivalent is rail replacement — the most plausible O&M cost driver. At 1 Hz, even if rails last 10^5 shots (historically optimistic for hypervelocity plasma-armature operation), rail replacement is required every ~28 hours. Target capsule fabrication at 1 Hz (28M/year) adds a second operating cost with no public estimate. Fixed O&M (labor, utilities, cooling water, pumps) follows conventional thermal plant patterns and is the most tractable component.
...
| Rail lifetime and replacement cost | truly-unknown | blocking | Dominant OPEX unknown; gap of ~6 orders of magnitude between demonstrated rail life and plant requirement |
| Capsule fabrication cost per shot | truly-unknown | important | At 28M shots/year, per-unit cost is critical; no estimate available |
...
| 7 | Per-shot capsule fabrication cost at 28M shots/year | S3, S5 | truly-unknown | important | IFE target fabrication literature provides lower bound; NearStar-specific capsule design not public |
