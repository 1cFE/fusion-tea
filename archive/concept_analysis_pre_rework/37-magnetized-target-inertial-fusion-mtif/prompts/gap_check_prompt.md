...
You are performing a data gap assessment for the fusion concept **Magnetized Target Inertial Fusion - MTIF (D-D)** (NearStar Fusion) as preparation for a comprehensive qualitative and quantitative concept analysis.
...
- **Dossier**: `/home/reid/1cfe/fusion-tea/knowledge/concept_research/37-magnetized-target-inertial-fusion-mtif/dossier.md`
...
- `/home/reid/1cfe/fusion-tea/knowledge/concept_research/37-magnetized-target-inertial-fusion-mtif/iter-01/sources/nearstar-mtif-technical-overview.md` (2 KB)
...
1. **Skim the index below first** to identify which fleet-wide sources are plausibly applicable to **Magnetized Target Inertial Fusion - MTIF (D-D)** (match on confinement family, fuel cycle, plant type, or cost-modeling scope).
