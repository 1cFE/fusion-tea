...
- **Dossier**: `/home/reid/1cfe/fusion-tea/knowledge/concept_research/24-dense-plasma-focus/dossier.md`
...
1. **Skim the index below first** to identify which fleet-wide sources are plausibly applicable to **Dense Plasma Focus (p-B11)** (match on confinement family, fuel cycle, plant type, or cost-modeling scope).
