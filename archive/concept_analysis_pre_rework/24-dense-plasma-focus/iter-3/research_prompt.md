# Research Agent: Autonomous Source Acquisition for Dense Plasma Focus (p-B11)
...
### G-11: Enriched decaborane cost at commercial scale: isotopic enrichment premium not quantified [PARTIAL]
- Iteration 2: searched "boron-11 isotope enrichment cost commercial pricing B-11 supply", "enriched decaborane boron-11 isotopic separation cost per kilogram", "boron-11 enrichment commercial scale cost semiconductor industry 11BF3 pricing 2024"
  - Extracted: lppfusion-proton-boron-p11b-fuel-arrives (https://www.lppfusion.com/proton-boron-p11b-fuel-arrives/)

### G-15: Diamond-film switch lifetime and commercial availability [PARTIAL]
- Iteration 2: searched "diamond film switch pulsed power fast switch UV laser photoconductive semiconductor switching lifetime"
  - Extracted: ipo-ipo-technologies-instruments-sensors-and-electronics (https://ipo.llnl.gov/ipo-technologies/instruments-sensors-and-electronics/diamond-photoconductive-semiconductor-switch)
...
`/home/reid/1cfe/fusion-tea/exploration/concept_analysis/analyses/24-dense-plasma-focus/iter-3/research_output.json`
