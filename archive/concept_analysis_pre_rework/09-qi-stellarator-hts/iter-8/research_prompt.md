...
### G-4: Gross thermal efficiency and power cycle specification [PARTIAL]
...
- Iteration 7: searched "WCLL blanket "thermal efficiency" OR "gross efficiency" EUROfusion DEMO water cooled lithium lead steam Rankine cycle site:arxiv.org OR site:osti.gov"
  - Extracted: arxiv-1401-4232 (https://arxiv.org/abs/1401.4232)

### G-6: Q value and steady-state ECRH requirement post-ignition [FAILED]
...
- Iteration 5: searched (no queries)
- Iteration 7: searched "Stellaris Proxima Fusion "Q value" OR "plasma gain" OR "thermal efficiency" OR "gross efficiency" OR "number of coils" technical parameters 2025"
...
- Iteration 7: searched "Proxima Fusion Stellaris coil number non-planar modular HTS coil mass remote maintenance", "W7-X Wendelstein 7-X "50 non-planar coils" OR "50 modular coils" coil mass kg manufacturing cost stellarator"
  - Extracted: en-wiki-wendelstein-7-x (https://en.wikipedia.org/wiki/Wendelstein_7-X)

### G-12: Plasma current profile and bootstrap fraction [SKIPPED]
...
`/home/reid/1cfe/fusion-tea/exploration/concept_analysis/analyses/09-qi-stellarator-hts/iter-8/research_output.json`
