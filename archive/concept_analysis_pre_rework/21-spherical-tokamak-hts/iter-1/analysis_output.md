...
| Plant capacity factor | proprietary | blocking | Not published; pulsed operation (dwell periods for CS re-magnetization) creates additional uncertainty relative to steady-state designs |
...
| 5 | Plant capacity factor not published | S1, S5 | proprietary | blocking | Apply Araiinejad & Shirvan (2025) D-T MCF range (75–90%) as uncertainty bracket; flag pulsed ST operation as potential downward pressure on central estimate |
...
- **Capacity factor sensitivity**: The Araiinejad & Shirvan (2025) finding that capacity factor is a primary LCOE sensitivity for D-T MCF plants applies to ST-E1. The CFS analysis uses 75–90% as the uncertainty bracket; ST-E1's pulsed operation (dwell periods for CS re-magnetization) suggests the lower end of this range may be more appropriate absent a published availability target.
