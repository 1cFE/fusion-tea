# Research Agent: Autonomous Source Acquisition for Negative Triangularity Tokamak
...
### G-6: Thermal efficiency for commercial NT plant undisclosed — MANTA uses steam Rankine at low efficiency; commercial plant targets higher temperatures and cycles not specified [PARTIAL]
- Iteration 2: searched "ARIES fusion power plant thermal efficiency steam Rankine sCO2 Brayton cycle study", "STEP fusion plant thermal efficiency heat cycle power conversion site:osti.gov OR site:arxiv.org", "ARC fusion reactor power conversion thermodynamic cycles sCO2 Brayton efficiency arxiv preprint"
  - Extracted: osti-servlets-purl-1178069 (https://www.osti.gov/servlets/purl/1178069)

### G-8: Divertor cost differential NT vs. PT not separately quantified in MANTA study — NT simpler divertor quantified in MANTA design philosophy but not separately cost-estimated [PARTIAL]
- Iteration 2: searched "tokamak divertor cost estimate ARIES study capital cost breakdown"
  - Extracted: qedfusion-lib-report-aries-act-ucsd-cer-13-01 (https://qedfusion.org/LIB/REPORT/ARIES-ACT/UCSD-CER-13-01.pdf)

### G-10: Capacity factor for a commercial NT plant — MANTA 37% is pilot-plant-specific; commercial NT tokamak availability target unknown [SKIPPED]
- Iteration 2: searched (no queries)

### G-14: NT disruption characteristics and wall impact at high plasma current — DIII-D NT disruption experiments; review TCV data [CLOSED]
- Iteration 2: searched "negative triangularity tokamak disruption DIII-D TCV plasma current wall impact site:arxiv.org"
  - Extracted: arxiv-2401-15217 (https://arxiv.org/abs/2401.15217)

### G-13: REBCO tape total demand for MANTA-scale TF coil set — derivable from MANTA TF coil geometry if dimensions published [SKIPPED]
- Iteration 2: searched (no queries)
...
```
uv run python scripts/run_analysis.py add-source 29 "<url>"
```
...
`/home/reid/1cfe/fusion-tea/exploration/concept_analysis/analyses/29-negative-triangularity-tokamak/iter-3/research_output.json`
