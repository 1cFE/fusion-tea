...
You are performing a data gap assessment for the fusion concept **Negative Triangularity Tokamak (D-T)** (Firefly Fusion) as preparation for a comprehensive qualitative and quantitative concept analysis.
...
- **Dossier**: `/home/reid/1cfe/fusion-tea/knowledge/concept_research/29-negative-triangularity-tokamak/dossier.md`
...
1. **Skim the index below first** to identify which fleet-wide sources are plausibly applicable to **Negative Triangularity Tokamak (D-T)** (match on confinement family, fuel cycle, plant type, or cost-modeling scope).
