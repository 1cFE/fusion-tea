...
You are performing a data gap assessment for the fusion concept **Laser ICF - Liquid Jet Target (D-D)** (Cortex Fusion) as preparation for a comprehensive qualitative and quantitative concept analysis.
...
- **Dossier**: `/home/reid/1cfe/fusion-tea/knowledge/concept_research/03-laser-icf-liquid-jet-target/dossier.md`
...
1. **Skim the index below first** to identify which fleet-wide sources are plausibly applicable to **Laser ICF - Liquid Jet Target (D-D)** (match on confinement family, fuel cycle, plant type, or cost-modeling scope).
