# 1costingfe Model Setup: Laser ICF - Liquid Jet Target (D-D)

You are generating a runnable 1costingfe model setup script for **Laser ICF - Liquid Jet Target (D-D)**
...
## Output
Write the script to: `/home/reid/1cfe/fusion-tea/exploration/concept_analysis/analyses/03-laser-icf-liquid-jet-target/model_setup.py`
