# 1costingfe Model Setup: FRC w/ Direct Conversion

You are generating a runnable 1costingfe model setup script for **FRC w/ Direct Conversion**
(Helion Energy).
...
`/home/reid/1cfe/1costingfe/examples/dhe3_pulsed_frc.py`
...
## Output
Write the script to: `/home/reid/1cfe/fusion-tea/exploration/concept_analysis/analyses/08-frc-w-direct-conversion/model_setup.py`
