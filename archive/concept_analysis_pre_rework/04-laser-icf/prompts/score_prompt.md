# Score: Laser ICF - p-B11 Fast Ignition

You are adding Section 8 (LCOE Downselect Scoring) to an existing synthesis for
the fusion concept **Laser ICF - p-B11 Fast Ignition** (HB11 Energy, concept ID: 04-laser-icf).
...
`C:\Users\mallo\1cfe\fusion-tea\exploration\concept_analysis\analyses\04-laser-icf\synthesis.md`
...
### 5. Model Output
`C:\Users\mallo\1cfe\fusion-tea\exploration\concept_analysis\analyses\04-laser-icf\model_output.txt`
...
Write to: `C:\Users\mallo\1cfe\fusion-tea\exploration\concept_analysis\analyses\04-laser-icf\score_body.md`
