...
-------------
  ...
  - NRL converted Electra from KrF to ArF after the original KrF program;
    ...
    but the primary US government gas-laser IFE effort has moved to ArF.
...
print(f"                    H-2 also tests {ETA_PIN1_LOW*100:.0f}% lower bound (→ Qsci_min = {10/ETA_PIN1_LOW:.0f} for viability).")
