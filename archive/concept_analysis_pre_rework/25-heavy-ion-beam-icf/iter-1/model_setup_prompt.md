# 1costingfe Model Setup: Heavy Ion Beam ICF (D-T)

You are generating a runnable 1costingfe model setup script for **Heavy Ion Beam ICF (D-T)**
(Intensity Energy).
...
`/home/reid/1cfe/1costingfe/src/costingfe/data/defaults/ife_heavy_ion.yaml`
...
## Output
Write the script to: `/home/reid/1cfe/fusion-tea/exploration/concept_analysis/analyses/25-heavy-ion-beam-icf/iter-1/model_setup.py`
