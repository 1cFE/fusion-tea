...
You are performing a data gap assessment for the fusion concept **Sheared-Flow Stabilized Z-Pinch (D-T)** (Zap Energy) as preparation for a comprehensive qualitative and quantitative concept analysis.
...
- **Dossier**: `/home/reid/1cfe/fusion-tea/knowledge/concept_research/15-sheared-flow-stabilized-z-pinch/dossier.md`
...
1. **Skim the index below first** to identify which fleet-wide sources are plausibly applicable to **Sheared-Flow Stabilized Z-Pinch (D-T)** (match on confinement family, fuel cycle, plant type, or cost-modeling scope).
