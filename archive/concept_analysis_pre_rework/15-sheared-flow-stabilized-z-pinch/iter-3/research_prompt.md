# Research Agent: Autonomous Source Acquisition for Sheared-Flow Stabilized Z-Pinch
...
```
uv run python scripts/run_analysis.py add-source 15 "<url>"
```
...
`/home/reid/1cfe/fusion-tea/exploration/concept_analysis/analyses/15-sheared-flow-stabilized-z-pinch/iter-3/research_output.json`
